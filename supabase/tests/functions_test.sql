...
SELECT extensions.ok(
  (
    ...
    FROM pg_catalog.pg_proc AS procedure_entry
    WHERE procedure_entry.oid =
      'public.curriculum_publish_theory_section(uuid,uuid,integer,uuid)'::pg_catalog.regprocedure
  )
  AND (
    SELECT pg_catalog.count(*) = 1
    FROM pg_catalog.pg_proc AS procedure_entry
    JOIN pg_catalog.pg_namespace AS procedure_namespace
      ON procedure_namespace.oid = procedure_entry.pronamespace
    WHERE procedure_namespace.nspname = 'public'
      AND procedure_entry.proname = 'curriculum_publish_theory_section'
  )
  AND NOT EXISTS (
    SELECT 1
    FROM (
  ...
  'published-theory-section publication facade is owner-controlled, fixed-path, exact-name, and server-only'
);
...
SELECT extensions.ok(
  (
    ...
    FROM pg_catalog.pg_proc AS procedure_entry
    WHERE procedure_entry.oid =
      'public.assessment_publish_exercise(uuid,uuid,integer,uuid)'::pg_catalog.regprocedure
  )
  AND (
    SELECT pg_catalog.count(*) = 1
    FROM pg_catalog.pg_proc AS procedure_entry
    JOIN pg_catalog.pg_namespace AS procedure_namespace
      ON procedure_namespace.oid = procedure_entry.pronamespace
    WHERE procedure_namespace.nspname = 'public'
      AND procedure_entry.proname = 'assessment_publish_exercise'
  )
  AND NOT EXISTS (
    SELECT 1
    FROM (
...
SELECT extensions.ok(
  (
    ...
    FROM pg_catalog.pg_proc AS procedure_entry
    WHERE procedure_entry.oid =
      'public.curriculum_publish_chapter(uuid,uuid,integer,uuid)'::pg_catalog.regprocedure
  )
  AND (
    SELECT pg_catalog.count(*) = 1
    FROM pg_catalog.pg_proc AS procedure_entry
    JOIN pg_catalog.pg_namespace AS procedure_namespace
      ON procedure_namespace.oid = procedure_entry.pronamespace
    WHERE procedure_namespace.nspname = 'public'
      AND procedure_entry.proname = 'curriculum_publish_chapter'
  )
  AND NOT EXISTS (
    SELECT 1
    FROM (
...
BEGIN
  ...
  BEGIN
    PERFORM *
    FROM public.curriculum_publish_theory_section(
      'c3000000-0000-0000-0000-000000000005',
  ...
  END;
  IF NOT v_rejected THEN
    RAISE EXCEPTION 'authenticated role unexpectedly executed a theory-section publication facade';
  END IF;

  v_rejected := false;
  BEGIN
    PERFORM *
    FROM public.assessment_publish_exercise(
      'c3000000-0000-0000-0000-000000000005',
  ...
  BEGIN
    PERFORM *
    FROM public.curriculum_publish_chapter(
      'c3000000-0000-0000-0000-000000000005',
      'c32f0000-0000-0000-0000-000000000001',
      2,
      'c5030000-0000-0000-0000-000000000001'
    );
  EXCEPTION WHEN insufficient_privilege THEN
    v_rejected := true;
  END;
...
-- The publication facade reuses the completed correction fixture for the
-- visible parent path and adds isolated valid draft targets for every other
-- permitted parent-state combination. The direct owner setup is intentional:
-- only the named service-role facade below performs lifecycle work under test.
SET LOCAL ROLE coditza_owner;
INSERT INTO public.modules (
  id,
  slug,
...
VALUES (
  'c4100000-0000-0000-0000-000000000001',
  'draft-module-published-chapter-publication',
  'Draft module with published chapter',
  'Isolated hierarchy for draft-module theory publication verification.',
  9900,
  'c3000000-0000-0000-0000-000000000004',
  'c3000000-0000-0000-0000-000000000004'
);
...
VALUES (
  ...
  'c4100000-0000-0000-0000-000000000001',
  'published-child-under-draft-module',
  'Published chapter under draft module',
  'This fixture isolates the draft-module/published-chapter path.',
  0,
  20,
  'c3000000-0000-0000-0000-000000000004',
  'c3000000-0000-0000-0000-000000000004'
...
VALUES
  (
    ...
    'c4200000-0000-0000-0000-000000000001',
    'Draft theory under draft module',
    'This valid theory proves publication under a draft module and published chapter.',
    0,
    14,
    'c3000000-0000-0000-0000-000000000004',
    'c3000000-0000-0000-0000-000000000004'
  ...
  (
    'c4310000-0000-0000-0000-000000000001',
    'c32f0000-0000-0000-0000-000000000001',
    'Draft theory under draft chapter',
    'This valid theory proves publication under a published module and draft chapter.',
    0,
    13,
    'c3000000-0000-0000-0000-000000000004',
    'c3000000-0000-0000-0000-000000000004'
  ...
  (
    'c4330000-0000-0000-0000-000000000001',
    'c32c0000-0000-0000-0000-000000000001',
    'Draft theory under archived chapter',
    'This valid draft must be rejected because its chapter is archived.',
    1,
    11,
    'c3000000-0000-0000-0000-000000000004',
    'c3000000-0000-0000-0000-000000000004'
  ...
  (
    'c4340000-0000-0000-0000-000000000001',
    'c3310000-0000-0000-0000-000000000001',
    'Draft theory under archived module',
    'This valid draft must be rejected because its module is archived.',
    1,
    12,
    'c3000000-0000-0000-0000-000000000004',
    'c3000000-0000-0000-0000-000000000004'
...
-- Sentinel snapshots ensure that publication beneath an ineffective ancestor
-- proves the stronger no-write rule instead of merely observing absent rows.
DO $published_theory_section_publication_seed_progress$
DECLARE
  v_seed record;
BEGIN
  FOR v_seed IN
    ...
    ) AS seed(user_id, chapter_id)
  LOOP
    PERFORM pg_catalog.set_config(
      'coditza.learning_write',
      'progress:' || v_seed.user_id::text || ':' || v_seed.chapter_id::text,
      true
    );
...
END;
$published_theory_section_publication_seed_progress$;
RESET ROLE;

SET LOCAL ROLE coditza_owner;
DO $published_theory_section_publication_initial_snapshot$
DECLARE
  v_target_snapshots jsonb;
  v_parent_snapshots jsonb;
  v_unrelated_fingerprint text;
  v_invisible_progress_snapshot jsonb;
  v_affected_user_ids jsonb;
  v_user_one_first_completed_at text;
  v_user_one_completed_at text;
BEGIN
  SELECT pg_catalog.jsonb_object_agg(
    theory_entry.id::text,
    pg_catalog.jsonb_build_object(
      'chapterId', theory_entry.chapter_id::text,
      'title', theory_entry.title,
      'bodyMarkdown', theory_entry.body_markdown,
      'position', theory_entry.position,
      'estimatedMinutes', theory_entry.estimated_minutes,
      'createdAt', theory_entry.created_at::text,
      'createdBy', theory_entry.created_by::text
    )
  )
  INTO v_target_snapshots
  FROM public.theory_sections AS theory_entry
  WHERE theory_entry.id IN (
    'c3c30000-0000-0000-0000-000000000001'::uuid,
    'c4300000-0000-0000-0000-000000000001'::uuid,
    'c4310000-0000-0000-0000-000000000001'::uuid,
    'c33f0000-0000-0000-0000-000000000001'::uuid
  );
  ...
  INTO v_parent_snapshots;

  SELECT COALESCE(
    pg_catalog.jsonb_agg(
      pg_catalog.to_jsonb(progress_entry)
      ORDER BY progress_entry.user_id, progress_entry.chapter_id
    ),
    '[]'::jsonb
  )
  INTO v_invisible_progress_snapshot
  FROM public.chapter_progress AS progress_entry
  WHERE (progress_entry.user_id, progress_entry.chapter_id) IN (
    (
      'c3000000-0000-0000-0000-000000000002'::uuid,
      'c32e0000-0000-0000-0000-000000000001'::uuid
    ),
  ...
  SELECT
    progress_entry.first_completed_at::text,
    progress_entry.completed_at::text
  INTO v_user_one_first_completed_at, v_user_one_completed_at
  FROM public.chapter_progress AS progress_entry
  WHERE progress_entry.user_id =
      'c3000000-0000-0000-0000-000000000001'::uuid
    AND progress_entry.chapter_id =
  ...
  IF v_target_snapshots IS NULL
    OR v_parent_snapshots IS NULL
    OR v_user_one_first_completed_at IS NULL
    OR v_user_one_completed_at IS NULL
    ...
    OR NOT EXISTS (
      ...
      WHERE progress_entry.user_id =
        ...
        AND progress_entry.chapter_id =
          'c3200000-0000-0000-0000-000000000001'::uuid
        AND progress_entry.theory_percent = 41
        AND progress_entry.exercise_percent = 42
        AND progress_entry.quiz_percent = 43
        AND progress_entry.overall_percent = 42
    ) THEN
    RAISE EXCEPTION 'published theory publication fixture is incomplete';
  END IF;
  ...
  SELECT pg_catalog.md5(
    COALESCE(
      pg_catalog.jsonb_agg(
        pg_catalog.jsonb_build_object(
          'kind',
          unchanged_entry.kind,
          'stateDigest',
          pg_catalog.md5(unchanged_entry.state::text)
        )
        ORDER BY unchanged_entry.kind, pg_catalog.md5(unchanged_entry.state::text)
      )::text,
      '[]'
    )
  )
  INTO v_unrelated_fingerprint
  FROM (
    SELECT 'module'::text AS kind, pg_catalog.to_jsonb(module_entry) AS state
    FROM public.modules AS module_entry

    UNION ALL

    SELECT 'chapter'::text, pg_catalog.to_jsonb(chapter_entry)
    FROM public.chapters AS chapter_entry

    UNION ALL

    SELECT 'theory_section'::text, pg_catalog.to_jsonb(theory_entry)
    FROM public.theory_sections AS theory_entry
    WHERE theory_entry.id NOT IN (
      'c3c30000-0000-0000-0000-000000000001'::uuid,
      'c4300000-0000-0000-0000-000000000001'::uuid,
      'c4310000-0000-0000-0000-000000000001'::uuid,
      'c33f0000-0000-0000-0000-000000000001'::uuid
    ...
    SELECT 'exercise'::text, pg_catalog.to_jsonb(exercise_entry)
    FROM public.exercises AS exercise_entry

    UNION ALL

    SELECT 'exercise_option'::text, pg_catalog.to_jsonb(option_entry)
    FROM public.exercise_options AS option_entry

    UNION ALL

    SELECT 'exercise_key'::text, pg_catalog.to_jsonb(answer_key)
    FROM private.exercise_answer_keys AS answer_key

    UNION ALL

    SELECT 'quiz'::text, pg_catalog.to_jsonb(quiz_entry)
    FROM public.quizzes AS quiz_entry

    UNION ALL

    SELECT 'quiz_question'::text, pg_catalog.to_jsonb(question_entry)
    FROM public.quiz_questions AS question_entry

    UNION ALL

    SELECT 'quiz_option'::text, pg_catalog.to_jsonb(option_entry)
    FROM public.quiz_question_options AS option_entry

    UNION ALL

    SELECT 'quiz_key'::text, pg_catalog.to_jsonb(answer_key)
    FROM private.quiz_question_answer_keys AS answer_key

    UNION ALL

    SELECT 'theory_completion'::text, pg_catalog.to_jsonb(completion_entry)
    FROM public.theory_section_completions AS completion_entry

    UNION ALL

    SELECT 'exercise_attempt'::text, pg_catalog.to_jsonb(attempt_entry)
    FROM public.exercise_attempts AS attempt_entry

    UNION ALL

    SELECT 'quiz_attempt'::text, pg_catalog.to_jsonb(attempt_entry)
    FROM public.quiz_attempts AS attempt_entry

    UNION ALL

    SELECT 'quiz_attempt_answer'::text, pg_catalog.to_jsonb(answer_entry)
    FROM public.quiz_attempt_answers AS answer_entry

    UNION ALL

    SELECT 'chapter_progress'::text, pg_catalog.to_jsonb(progress_entry)
    FROM public.chapter_progress AS progress_entry
    WHERE progress_entry.chapter_id <>
      'c3200000-0000-0000-0000-000000000001'::uuid
    ...
    SELECT 'idempotency_record'::text, pg_catalog.to_jsonb(record_entry)
    FROM private.idempotency_records AS record_entry
  ) AS unchanged_entry;

  PERFORM pg_catalog.set_config(
    'coditza.slice21_target_snapshots',
    v_target_snapshots::text,
    true
  );
  PERFORM pg_catalog.set_config(
    'coditza.slice21_parent_snapshots',
    v_parent_snapshots::text,
    true
  );
  PERFORM pg_catalog.set_config(
    'coditza.slice21_invisible_progress',
    v_invisible_progress_snapshot::text,
    true
  );
  PERFORM pg_catalog.set_config(
    'coditza.slice21_pp_candidates',
    v_affected_user_ids::text,
    true
  );
  PERFORM pg_catalog.set_config(
    'coditza.slice21_user_one_first_completed_at',
    v_user_one_first_completed_at,
    true
  );
  PERFORM pg_catalog.set_config(
    'coditza.slice21_unrelated_fingerprint',
    v_unrelated_fingerprint,
    true
  );
END;
$published_theory_section_publication_initial_snapshot$;
RESET ROLE;

-- The unique-position check is explicitly made by the lifecycle facade. A
-- deferred duplicate in a nested rollback proves malformed draft readiness is
-- refused before the one lifecycle update can run.
SET LOCAL ROLE coditza_owner;
DO $published_theory_section_publication_position_readiness_denial$
DECLARE
  v_rejected boolean := false;
BEGIN
  BEGIN
    ...
    UPDATE public.theory_sections
    SET position = 0
    WHERE id = 'c3c30000-0000-0000-0000-000000000001';
    ...
    FROM public.curriculum_publish_theory_section(
      ...
      'c3c30000-0000-0000-0000-000000000001',
      3,
      'c4010000-0000-0000-0000-000000000018'
    );
  EXCEPTION WHEN raise_exception THEN
    v_rejected := true;
  END;
  ...
  IF NOT v_rejected THEN
    RAISE EXCEPTION 'theory publication accepted a duplicate draft sibling position';
  END IF;
END;
$published_theory_section_publication_position_readiness_denial$;
RESET ROLE;

SET LOCAL ROLE service_role;
DO $curriculum_publish_theory_section_validation$
DECLARE
  v_invalid_case record;
  v_rejected boolean;
BEGIN
    ...
    FROM (
      VALUES
        (
          ...
          'c3c30000-0000-0000-0000-000000000001'::uuid,
          2::integer,
          'c4010000-0000-0000-0000-000000000002'::uuid
        ),
        (
          'held actor',
          'c3000000-0000-0000-0000-000000000006'::uuid,
          'c3c30000-0000-0000-0000-000000000001'::uuid,
          2::integer,
          'c4010000-0000-0000-0000-000000000003'::uuid
        ),
        (
          'null actor',
          NULL::uuid,
          'c3c30000-0000-0000-0000-000000000001'::uuid,
          2::integer,
          'c4010000-0000-0000-0000-000000000004'::uuid
        ),
        (
          'missing actor',
          'c3000000-0000-0000-0000-000000000999'::uuid,
          'c3c30000-0000-0000-0000-000000000001'::uuid,
          2::integer,
          'c4010000-0000-0000-0000-000000000005'::uuid
        ),
        (
          'null theory section',
          'c3000000-0000-0000-0000-000000000005'::uuid,
          NULL::uuid,
          2::integer,
          'c4010000-0000-0000-0000-000000000006'::uuid
        ),
        (
          'missing theory section',
          'c3000000-0000-0000-0000-000000000005'::uuid,
          'c4390000-0000-0000-0000-000000000001'::uuid,
          2::integer,
          'c4010000-0000-0000-0000-000000000007'::uuid
        ),
        (
          ...
          'c3c30000-0000-0000-0000-000000000001'::uuid,
          NULL::integer,
          'c4010000-0000-0000-0000-000000000008'::uuid
        ),
        (
          ...
          'c3c30000-0000-0000-0000-000000000001'::uuid,
          0::integer,
          'c4010000-0000-0000-0000-000000000009'::uuid
        ),
        (
          ...
          'c3c30000-0000-0000-0000-000000000001'::uuid,
          (-1)::integer,
          'c4010000-0000-0000-0000-000000000010'::uuid
        ),
        (
        ...
        (
          ...
          'c33e0000-0000-0000-0000-000000000001'::uuid,
          1::integer,
          'c4010000-0000-0000-0000-000000000012'::uuid
        ),
        (
          'archived target',
          'c3000000-0000-0000-0000-000000000005'::uuid,
          'c33b0000-0000-0000-0000-000000000001'::uuid,
          2::integer,
          'c4010000-0000-0000-0000-000000000013'::uuid
        ),
        (
          'draft target under archived chapter',
          'c3000000-0000-0000-0000-000000000005'::uuid,
          'c4330000-0000-0000-0000-000000000001'::uuid,
          1::integer,
          'c4010000-0000-0000-0000-000000000014'::uuid
        ),
        (
          'draft target under archived module',
          'c3000000-0000-0000-0000-000000000005'::uuid,
          'c4340000-0000-0000-0000-000000000001'::uuid,
          1::integer,
          'c4010000-0000-0000-0000-000000000015'::uuid
        ),
        (
          ...
          'c33c0000-0000-0000-0000-000000000001'::uuid,
          2::integer,
          'c4010000-0000-0000-0000-000000000016'::uuid
        ),
        (
          ...
          'c33d0000-0000-0000-0000-000000000001'::uuid,
          2::integer,
          'c4010000-0000-0000-0000-000000000017'::uuid
        )
    ) AS invalid_case(
      label,
      actor_user_id,
  ...
  LOOP
    ...
    IF NOT v_rejected THEN
      RAISE EXCEPTION 'theory publication unexpectedly accepted invalid case: %',
        v_invalid_case.label;
    END IF;
  END LOOP;
END;
$curriculum_publish_theory_section_validation$;
RESET ROLE;

SET LOCAL ROLE service_role;
DO $curriculum_publish_theory_section_effective_parent_success$
DECLARE
  v_published record;
BEGIN
  ...
  FROM public.curriculum_publish_theory_section(
    ...
    'c3c30000-0000-0000-0000-000000000001',
    2,
    'c4010000-0000-0000-0000-000000000040'
  );
  ...
  IF v_published.response_status <> 200
    ...
    RAISE EXCEPTION 'theory publication did not return its safe effective-parent result';
  END IF;
END;
$curriculum_publish_theory_section_effective_parent_success$;
RESET ROLE;

SET LOCAL ROLE coditza_owner;
DO $published_theory_section_publication_effective_snapshot$
DECLARE
...
BEGIN
  SELECT
    theory_entry.updated_at::text,
    theory_entry.updated_by::text,
    theory_entry.published_at::text
  ...
  IF v_target_updated_at IS NULL
    OR v_target_updated_by IS NULL
    OR v_target_published_at IS NULL THEN
    RAISE EXCEPTION 'effective theory publication did not create target metadata';
  END IF;

  PERFORM pg_catalog.set_config(
    'coditza.slice21_pp_target_updated_at',
    v_target_updated_at,
    true
  );
  PERFORM pg_catalog.set_config(
    'coditza.slice21_pp_target_updated_by',
    v_target_updated_by,
    true
  );
  PERFORM pg_catalog.set_config(
    'coditza.slice21_pp_target_published_at',
    v_target_published_at,
    true
  );
  PERFORM pg_catalog.set_config(
    'coditza.slice21_pp_progress_fingerprint',
    v_progress_fingerprint,
    true
  );
END;
$published_theory_section_publication_effective_snapshot$;
RESET ROLE;

SET LOCAL ROLE service_role;
DO $curriculum_publish_theory_section_retry_and_ineffective_parent_successes$
DECLARE
  v_retry record;
...
BEGIN
  ...
  FROM public.curriculum_publish_theory_section(
    ...
    'c3c30000-0000-0000-0000-000000000001',
    2,
    'c4010000-0000-0000-0000-000000000041'
  );
  ...
  FROM public.curriculum_publish_theory_section(
    ...
    'c4310000-0000-0000-0000-000000000001',
    1,
    'c4010000-0000-0000-0000-000000000042'
  );
  ...
  FROM public.curriculum_publish_theory_section(
    ...
    'c4300000-0000-0000-0000-000000000001',
    1,
    'c4010000-0000-0000-0000-000000000043'
  );
  ...
  FROM public.curriculum_publish_theory_section(
    ...
    'c33f0000-0000-0000-0000-000000000001',
    1,
    'c4010000-0000-0000-0000-000000000044'
  );
  ...
  IF v_retry.response_status <> 200
    ...
    OR v_published_under_published_draft.response_body IS DISTINCT FROM
      pg_catalog.jsonb_build_object(
        'id', 'c4310000-0000-0000-0000-000000000001',
        'rowVersion', 2
      )
    ...
    OR v_published_under_draft_published.response_body IS DISTINCT FROM
      pg_catalog.jsonb_build_object(
        'id', 'c4300000-0000-0000-0000-000000000001',
        'rowVersion', 2
      )
    OR v_published_under_draft_draft.response_status <> 200
    OR v_published_under_draft_draft.response_body IS DISTINCT FROM
      pg_catalog.jsonb_build_object(
        'id', 'c33f0000-0000-0000-0000-000000000001',
        'rowVersion', 2
      ) THEN
    RAISE EXCEPTION 'theory publication did not preserve retry or non-effective-parent success semantics';
  END IF;
END;
$curriculum_publish_theory_section_retry_and_ineffective_parent_successes$;
RESET ROLE;

SET LOCAL ROLE coditza_owner;
DO $published_theory_section_publication_state_preservation$
DECLARE
  v_target_snapshots jsonb;
  v_parent_snapshots jsonb;
  v_invisible_progress_snapshot jsonb;
  v_unrelated_fingerprint text;
  v_pp_progress_fingerprint text;
  v_pp_user_ids jsonb;
BEGIN
  SELECT pg_catalog.jsonb_object_agg(
    theory_entry.id::text,
  ...
  INTO v_pp_progress_fingerprint
  FROM public.chapter_progress AS progress_entry
  WHERE progress_entry.chapter_id =
    'c3200000-0000-0000-0000-000000000001'::uuid;

  SELECT COALESCE(
    pg_catalog.jsonb_agg(progress_entry.user_id::text ORDER BY progress_entry.user_id),
    '[]'::jsonb
  )
  INTO v_pp_user_ids
  FROM public.chapter_progress AS progress_entry
  ...
  IF v_target_snapshots IS DISTINCT FROM pg_catalog.current_setting(
      'coditza.slice21_target_snapshots',
      true
    )::jsonb
    OR v_parent_snapshots IS DISTINCT FROM pg_catalog.current_setting(
      'coditza.slice21_parent_snapshots',
      true
    )::jsonb
    OR v_invisible_progress_snapshot IS DISTINCT FROM pg_catalog.current_setting(
      'coditza.slice21_invisible_progress',
      true
    )::jsonb
    OR v_unrelated_fingerprint IS DISTINCT FROM pg_catalog.current_setting(
      'coditza.slice21_unrelated_fingerprint',
      true
    )
    OR v_pp_progress_fingerprint IS DISTINCT FROM pg_catalog.current_setting(
      'coditza.slice21_pp_progress_fingerprint',
      true
    )
    OR v_pp_user_ids IS DISTINCT FROM pg_catalog.current_setting(
      'coditza.slice21_pp_candidates',
      true
    )::jsonb THEN
    RAISE EXCEPTION 'theory publication changed an unrelated root, source, history, or ineffective-parent progress row';
  END IF;
  ...
  IF NOT EXISTS (
    ...
    WHERE theory_entry.id = 'c3c30000-0000-0000-0000-000000000001'
      AND theory_entry.status = 'published'::public.content_status
      AND theory_entry.published_at::text = pg_catalog.current_setting(
        'coditza.slice21_pp_target_published_at',
        true
      )
      AND theory_entry.row_version = 3
      AND theory_entry.updated_at::text = pg_catalog.current_setting(
        'coditza.slice21_pp_target_updated_at',
        true
      )
      AND theory_entry.updated_by::text = pg_catalog.current_setting(
        'coditza.slice21_pp_target_updated_by',
        true
      )
      AND theory_entry.updated_by =
    ...
    OR NOT EXISTS (
      SELECT 1
      FROM public.theory_sections AS theory_entry
      WHERE theory_entry.id = 'c4310000-0000-0000-0000-000000000001'
        AND theory_entry.status = 'published'::public.content_status
        AND theory_entry.published_at IS NOT NULL
        AND theory_entry.row_version = 2
        AND theory_entry.updated_by =
    ...
    OR NOT EXISTS (
      SELECT 1
      FROM public.theory_sections AS theory_entry
      WHERE theory_entry.id = 'c4300000-0000-0000-0000-000000000001'
        AND theory_entry.status = 'published'::public.content_status
        AND theory_entry.published_at IS NOT NULL
        AND theory_entry.row_version = 2
        AND theory_entry.updated_by =
    ...
    RAISE EXCEPTION 'theory publication did not preserve exact target lifecycle fields';
  END IF;
  ...
  IF NOT EXISTS (
    ...
    WHERE progress_entry.user_id =
      ...
      AND progress_entry.chapter_id =
        'c3200000-0000-0000-0000-000000000001'::uuid
      AND progress_entry.theory_percent = 50
      AND progress_entry.exercise_percent = 100
      AND progress_entry.quiz_percent = 100
      AND progress_entry.overall_percent = 83
    ...
    RAISE EXCEPTION 'effective theory publication did not recalculate every affected progress source correctly';
  END IF;
END;
$published_theory_section_publication_state_preservation$;
...
SELECT extensions.ok(
  (
    SELECT pg_catalog.count(*) = 4
      AND pg_catalog.bool_and(
        audit_entry.actor_kind = 'user'
        AND audit_entry.action = 'theory_section_published'
        AND audit_entry.entity_type = 'theory_section'
        AND audit_entry.changed_fields = ARRAY['status']::text[]
        AND audit_entry.change_summary =
        ...
        AND (
          (
            ...
            AND audit_entry.entity_id =
              'c3c30000-0000-0000-0000-000000000001'::uuid
            AND audit_entry.request_id =
              'c4010000-0000-0000-0000-000000000040'::uuid
          )
          OR (
            audit_entry.actor_user_id =
              'c3000000-0000-0000-0000-000000000005'::uuid
            AND audit_entry.entity_id =
              'c4310000-0000-0000-0000-000000000001'::uuid
            AND audit_entry.request_id =
              'c4010000-0000-0000-0000-000000000042'::uuid
          )
          OR (
            audit_entry.actor_user_id =
              'c3000000-0000-0000-0000-000000000004'::uuid
            AND audit_entry.entity_id =
              'c4300000-0000-0000-0000-000000000001'::uuid
            AND audit_entry.request_id =
              'c4010000-0000-0000-0000-000000000043'::uuid
          )
          OR (
            audit_entry.actor_user_id =
              'c3000000-0000-0000-0000-000000000005'::uuid
            AND audit_entry.entity_id =
              'c33f0000-0000-0000-0000-000000000001'::uuid
            AND audit_entry.request_id =
              'c4010000-0000-0000-0000-000000000044'::uuid
          )
        )
      )
    FROM private.audit_events AS audit_entry
    WHERE audit_entry.action = 'theory_section_published'
      AND audit_entry.entity_type = 'theory_section'
      AND audit_entry.entity_id IN (
        'c3c30000-0000-0000-0000-000000000001'::uuid,
        'c4300000-0000-0000-0000-000000000001'::uuid,
  ...
  AND NOT EXISTS (
    ...
    WHERE audit_entry.request_id IN (
      ...
      'c4010000-0000-0000-0000-000000000016'::uuid,
      'c4010000-0000-0000-0000-000000000017'::uuid,
      'c4010000-0000-0000-0000-000000000018'::uuid,
      'c4010000-0000-0000-0000-000000000041'::uuid
    )
  )
  AND NOT EXISTS (
    SELECT 1
  ...
  'theory publication locks the full path, validates readiness, recalculates every effective-progress source once, preserves ineffective-parent progress, audits only real transitions, and uses state-based retry without replay records'
);
RESET ROLE;

-- Slice 22 adds three fresh learner-only sources with no derived snapshot.
-- They make each non-snapshot arm of the publication candidate union
-- independently observable instead of letting an implementation that only
-- scans chapter_progress pass through the older fixtures.
INSERT INTO auth.users (
  id,
  aud,
  role,
...
VALUES
  (
    ...
    'authenticated',
    'authenticated',
    'exercise-publish-theory-source@coditza.invalid',
    '{}'::jsonb,
    '{"displayName":"Exercise Publish Theory Source"}'::jsonb,
    pg_catalog.now(),
    pg_catalog.now()
  ),
  (
    ...
    'authenticated',
    'authenticated',
    'exercise-publish-attempt-source@coditza.invalid',
    '{}'::jsonb,
    '{"displayName":"Exercise Publish Attempt Source"}'::jsonb,
    pg_catalog.now(),
    pg_catalog.now()
  ),
  (
    ...
    'authenticated',
    'authenticated',
    'exercise-publish-quiz-source@coditza.invalid',
    '{}'::jsonb,
    '{"displayName":"Exercise Publish Quiz Source"}'::jsonb,
    pg_catalog.now(),
    pg_catalog.now()
  );

SET LOCAL ROLE coditza_owner;
DO $assessment_publish_exercise_seed$
DECLARE
  v_exercise_id uuid;
BEGIN
  INSERT INTO public.exercises (
  ...
  VALUES
    (
      'c4400000-0000-0000-0000-000000000001',
      'c3200000-0000-0000-0000-000000000001',
      'Required exercise publication target',
      'Choose every correct publication property.',
    ...
    (
      'c4410000-0000-0000-0000-000000000001',
      'c32f0000-0000-0000-0000-000000000001',
      'Published-module draft-chapter target',
      'Answer yes.',
      'short_text'::public.exercise_type,
      90,
      3,
    ...
    (
      ...
      'c4200000-0000-0000-0000-000000000001',
      'Draft-module published-chapter target',
      'Answer yes.',
      'short_text'::public.exercise_type,
      90,
      3,
    ...
    (
      'c4430000-0000-0000-0000-000000000001',
      'c32e0000-0000-0000-0000-000000000001',
      'Draft-module draft-chapter target',
      'Answer yes.',
      'short_text'::public.exercise_type,
      90,
      3,
    ...
    (
      'c4490000-0000-0000-0000-000000000001',
      'c3200000-0000-0000-0000-000000000001',
      'Optional exercise publication target',
      'Answer yes.',
      'short_text'::public.exercise_type,
      91,
      2,
    ...
    (
      'c4440000-0000-0000-0000-000000000001',
      'c3200000-0000-0000-0000-000000000001',
      'Incomplete exercise publication target',
    ...
    (
      'c4450000-0000-0000-0000-000000000001',
      'c3200000-0000-0000-0000-000000000001',
      'Python exercise publication target',
    ...
    (
      'c44a0000-0000-0000-0000-000000000001',
      'c3200000-0000-0000-0000-000000000001',
      'One-option exercise publication target',
    ...
    (
      'c4460000-0000-0000-0000-000000000001',
      'c3200000-0000-0000-0000-000000000001',
      'Archived exercise publication target',
      'Answer yes.',
      'short_text'::public.exercise_type,
      95,
      1,
    ...
    (
      'c4470000-0000-0000-0000-000000000001',
      'c32c0000-0000-0000-0000-000000000001',
      'Archived-chapter draft exercise target',
      'Answer yes.',
      'short_text'::public.exercise_type,
      90,
      1,
    ...
    (
      'c4480000-0000-0000-0000-000000000001',
      'c3310000-0000-0000-0000-000000000001',
      'Archived-module draft exercise target',
      'Answer yes.',
      'short_text'::public.exercise_type,
      90,
      1,
    ...
    (
      'c44b0000-0000-0000-0000-000000000001',
      'c32c0000-0000-0000-0000-000000000001',
      'Archived-chapter published exercise target',
      'Answer yes.',
      'short_text'::public.exercise_type,
      91,
      1,
    ...
    (
      'c44c0000-0000-0000-0000-000000000001',
      'c3310000-0000-0000-0000-000000000001',
      'Archived-module published exercise target',
      'Answer yes.',
      'short_text'::public.exercise_type,
      91,
      1,
    ...
    (
      'c44d0000-0000-0000-0000-000000000001',
      'c3200000-0000-0000-0000-000000000001',
      'Duplicate-position exercise publication target',
  ...
  PERFORM pg_catalog.set_config(
    'coditza.assessment_tree_root',
    'exercise:c4400000-0000-0000-0000-000000000001',
    true
  );
  INSERT INTO public.exercise_options (
    id,
  ...
  VALUES
    ...
    (
      'c4500000-0000-0000-0000-000000000003',
      'c4400000-0000-0000-0000-000000000001',
      'Audits record only safe deltas.',
      2
    );
  INSERT INTO private.exercise_answer_keys (
    exercise_id,
  ...
  VALUES (
    'c4400000-0000-0000-0000-000000000001',
    '{"correctOptionIds":["c4500000-0000-0000-0000-000000000001","c4500000-0000-0000-0000-000000000003"]}'::jsonb,
    'Correct publication answer.',
    'Incorrect publication answer.',
    'c3000000-0000-0000-0000-000000000005',
    'c3000000-0000-0000-0000-000000000005'
  );
  ...
  PERFORM pg_catalog.set_config(
    'coditza.assessment_tree_root',
    'exercise:c44a0000-0000-0000-0000-000000000001',
    true
  );
  INSERT INTO public.exercise_options (
    id,
  ...
  VALUES (
    'c4510000-0000-0000-0000-000000000001',
    'c44a0000-0000-0000-0000-000000000001',
    'Only option.',
    0
  );
  ...
  VALUES (
    'c44a0000-0000-0000-0000-000000000001',
    '{"correctOptionId":"c4510000-0000-0000-0000-000000000001"}'::jsonb,
    'c3000000-0000-0000-0000-000000000005',
    'c3000000-0000-0000-0000-000000000005'
  );

  FOREACH v_exercise_id IN ARRAY ARRAY[
    'c4410000-0000-0000-0000-000000000001'::uuid,
    'c4420000-0000-0000-0000-000000000001'::uuid,
    'c4430000-0000-0000-0000-000000000001'::uuid,
    'c4490000-0000-0000-0000-000000000001'::uuid,
    'c4460000-0000-0000-0000-000000000001'::uuid,
    'c4470000-0000-0000-0000-000000000001'::uuid,
    'c4480000-0000-0000-0000-000000000001'::uuid,
    'c44b0000-0000-0000-0000-000000000001'::uuid,
    'c44c0000-0000-0000-0000-000000000001'::uuid
  ] LOOP
    PERFORM pg_catalog.set_config(
      'coditza.assessment_tree_root',
  ...
  WHERE id = 'c4460000-0000-0000-0000-000000000001';
  ...
  PERFORM pg_catalog.set_config(
    'coditza.learning_write',
    'theory:c3000000-0000-0000-0000-000000000007:c3300000-0000-0000-0000-000000000001',
    true
  );
  ...
  VALUES (
    'c4520000-0000-0000-0000-000000000001',
    'c3000000-0000-0000-0000-000000000008',
    'c3410000-0000-0000-0000-000000000001',
    1,
    '{"text":"yes"}'::jsonb,
  ...
  VALUES (
    'c4530000-0000-0000-0000-000000000001',
    'c3000000-0000-0000-0000-000000000009',
    'c3510000-0000-0000-0000-000000000001',
    1,
    1
  ...
  PERFORM pg_catalog.set_config('coditza.learning_write', '', true);
END;
$assessment_publish_exercise_seed$;

DO $assessment_publish_exercise_initial_snapshot$
DECLARE
  v_c440_root_snapshot jsonb;
  v_c440_tree_snapshot jsonb;
  v_parent_snapshot jsonb;
...
BEGIN
  SELECT pg_catalog.jsonb_build_object(
    'chapterId', exercise_entry.chapter_id::text,
    'title', exercise_entry.title,
    'promptMarkdown', exercise_entry.prompt_markdown,
    'exerciseType', exercise_entry.exercise_type::text,
    'position', exercise_entry.position,
    'points', exercise_entry.points,
    'isRequired', exercise_entry.is_required,
    'definitionVersion', exercise_entry.definition_version,
    'createdAt', exercise_entry.created_at::text,
    'createdBy', exercise_entry.created_by::text
  )
  INTO v_c440_root_snapshot
  FROM public.exercises AS exercise_entry
  WHERE exercise_entry.id = 'c4400000-0000-0000-0000-000000000001';
  ...
  SELECT pg_catalog.jsonb_build_object(
    ...
    COALESCE(
      (
        ...
        FROM public.exercise_options AS option_entry
        WHERE option_entry.exercise_id =
          'c4400000-0000-0000-0000-000000000001'::uuid
      ),
      '[]'::jsonb
    ),
    'answerKey',
    (
      SELECT pg_catalog.to_jsonb(answer_key)
      FROM private.exercise_answer_keys AS answer_key
      WHERE answer_key.exercise_id =
        'c4400000-0000-0000-0000-000000000001'::uuid
    )
  )
  INTO v_c440_tree_snapshot;
  ...
  IF v_c440_root_snapshot IS NULL
    OR v_c440_tree_snapshot -> 'answerKey' IS NULL
    ...
    OR (
      ...
      WHERE progress_entry.chapter_id =
        ...
        AND (
          progress_entry.theory_percent <> 0
          OR progress_entry.exercise_percent <> 0
          OR progress_entry.quiz_percent <> 0
          OR progress_entry.overall_percent <> 0
        )
    ) <> 0 THEN
    RAISE EXCEPTION 'exercise publication fixture is incomplete';
  END IF;

  PERFORM pg_catalog.set_config(
    'coditza.slice22_c440_root_snapshot',
    v_c440_root_snapshot::text,
    true
  );
  PERFORM pg_catalog.set_config(
    'coditza.slice22_c440_tree_snapshot',
    v_c440_tree_snapshot::text,
    true
  );
  PERFORM pg_catalog.set_config(
    'coditza.slice22_parent_snapshot',
    v_parent_snapshot::text,
    true
  );
  PERFORM pg_catalog.set_config(
    'coditza.slice22_ineffective_progress_snapshot',
    v_ineffective_progress_snapshot::text,
    true
  );
  PERFORM pg_catalog.set_config(
    'coditza.slice22_source_fingerprint',
    v_source_fingerprint,
    true
  );
  PERFORM pg_catalog.set_config(
    'coditza.slice22_first_completed_at',
    v_user_one_first_completed_at,
    true
  );
END;
$assessment_publish_exercise_initial_snapshot$;
RESET ROLE;
...
SET LOCAL ROLE coditza_owner;
DO $assessment_publish_exercise_position_readiness_denial$
DECLARE
  v_rejected boolean := false;
BEGIN
  BEGIN
    ...
    UPDATE public.exercises
    SET position = 90
    WHERE id = 'c44d0000-0000-0000-0000-000000000001';
    ...
    FROM public.assessment_publish_exercise(
      ...
      'c44d0000-0000-0000-0000-000000000001',
      2,
      'c5010000-0000-0000-0000-000000000011'
    );
  EXCEPTION WHEN raise_exception THEN
    v_rejected := true;
  END;
  ...
  IF NOT v_rejected THEN
    RAISE EXCEPTION 'exercise publication accepted a duplicate draft sibling position';
  END IF;
END;
$assessment_publish_exercise_position_readiness_denial$;
RESET ROLE;

SET LOCAL ROLE service_role;
DO $assessment_publish_exercise_validation$
DECLARE
  v_invalid_case record;
  v_rejected boolean;
BEGIN
    ...
    FROM (
      VALUES
        (
          ...
          'c4400000-0000-0000-0000-000000000001'::uuid,
          1::integer,
          'c5010000-0000-0000-0000-000000000002'::uuid
        ),
        (
          'held actor',
          'c3000000-0000-0000-0000-000000000006'::uuid,
          'c4400000-0000-0000-0000-000000000001'::uuid,
          1::integer,
          'c5010000-0000-0000-0000-000000000003'::uuid
        ),
        (
          'null actor',
          NULL::uuid,
          'c4400000-0000-0000-0000-000000000001'::uuid,
          1::integer,
          'c5010000-0000-0000-0000-000000000004'::uuid
        ),
        (
          'missing actor',
          'c3000000-0000-0000-0000-000000000999'::uuid,
          'c4400000-0000-0000-0000-000000000001'::uuid,
          1::integer,
          'c5010000-0000-0000-0000-000000000005'::uuid
        ),
        (
          'null exercise',
          'c3000000-0000-0000-0000-000000000005'::uuid,
          NULL::uuid,
          1::integer,
          'c5010000-0000-0000-0000-000000000006'::uuid
        ),
        (
          'missing exercise',
          'c3000000-0000-0000-0000-000000000005'::uuid,
          'c44f0000-0000-0000-0000-000000000001'::uuid,
          1::integer,
          'c5010000-0000-0000-0000-000000000007'::uuid
        ),
        (
          'null expected version',
          'c3000000-0000-0000-0000-000000000005'::uuid,
          'c4400000-0000-0000-0000-000000000001'::uuid,
          NULL::integer,
          'c5010000-0000-0000-0000-000000000008'::uuid
        ),
        (
          'zero expected version',
          'c3000000-0000-0000-0000-000000000005'::uuid,
          'c4400000-0000-0000-0000-000000000001'::uuid,
          0::integer,
          'c5010000-0000-0000-0000-000000000009'::uuid
        ),
        (
          'negative expected version',
          'c3000000-0000-0000-0000-000000000005'::uuid,
          'c4400000-0000-0000-0000-000000000001'::uuid,
          (-1)::integer,
          'c5010000-0000-0000-0000-000000000010'::uuid
        ),
        (
          'null request identifier',
          'c3000000-0000-0000-0000-000000000005'::uuid,
        ...
        (
          ...
          'c4400000-0000-0000-0000-000000000001'::uuid,
          2::integer,
          'c5010000-0000-0000-0000-000000000012'::uuid
        ),
        (
          'incomplete scalar definition',
          'c3000000-0000-0000-0000-000000000005'::uuid,
          'c4440000-0000-0000-0000-000000000001'::uuid,
          1::integer,
          'c5010000-0000-0000-0000-000000000013'::uuid
        ),
        (
          'python definition remains unavailable',
          'c3000000-0000-0000-0000-000000000005'::uuid,
          'c4450000-0000-0000-0000-000000000001'::uuid,
          1::integer,
          'c5010000-0000-0000-0000-000000000014'::uuid
        ),
        (
          'one-option choice definition',
          'c3000000-0000-0000-0000-000000000005'::uuid,
          'c44a0000-0000-0000-0000-000000000001'::uuid,
          1::integer,
          'c5010000-0000-0000-0000-000000000015'::uuid
        ),
        (
          'archived target',
          'c3000000-0000-0000-0000-000000000005'::uuid,
          'c4460000-0000-0000-0000-000000000001'::uuid,
          2::integer,
          'c5010000-0000-0000-0000-000000000016'::uuid
        ),
        (
          'draft target under archived chapter',
          'c3000000-0000-0000-0000-000000000005'::uuid,
          'c4470000-0000-0000-0000-000000000001'::uuid,
          1::integer,
          'c5010000-0000-0000-0000-000000000017'::uuid
        ),
        (
          'draft target under archived module',
          'c3000000-0000-0000-0000-000000000005'::uuid,
          'c4480000-0000-0000-0000-000000000001'::uuid,
          1::integer,
          'c5010000-0000-0000-0000-000000000018'::uuid
        ),
        (
          'published target under archived chapter',
          'c3000000-0000-0000-0000-000000000005'::uuid,
          'c44b0000-0000-0000-0000-000000000001'::uuid,
          2::integer,
          'c5010000-0000-0000-0000-000000000019'::uuid
        ),
        (
          'published target under archived module',
          'c3000000-0000-0000-0000-000000000005'::uuid,
          'c44c0000-0000-0000-0000-000000000001'::uuid,
          2::integer,
          'c5010000-0000-0000-0000-000000000020'::uuid
        )
    ) AS invalid_case(
      label,
      actor_user_id,
  ...
  LOOP
    ...
    IF NOT v_rejected THEN
      RAISE EXCEPTION 'exercise publication unexpectedly accepted invalid case: %',
        v_invalid_case.label;
    END IF;
  END LOOP;
END;
$assessment_publish_exercise_validation$;

DO $assessment_publish_exercise_effective_parent_success$
DECLARE
  v_published record;
BEGIN
  SELECT * INTO v_published
  FROM public.assessment_publish_exercise(
    ...
    'c4400000-0000-0000-0000-000000000001',
    1,
    'c5010000-0000-0000-0000-000000000040'
  );

  IF v_published.response_status <> 200
    OR v_published.response_body IS DISTINCT FROM pg_catalog.jsonb_build_object(
      'id', 'c4400000-0000-0000-0000-000000000001',
      'rowVersion', 2
    ) THEN
    RAISE EXCEPTION 'exercise publication did not return its safe effective-parent result';
  END IF;
END;
$assessment_publish_exercise_effective_parent_success$;
RESET ROLE;

SET LOCAL ROLE coditza_owner;
DO $assessment_publish_exercise_effective_snapshot$
DECLARE
  v_target_updated_at text;
  v_target_updated_by text;
  v_target_published_at text;
...
BEGIN
  SELECT
    exercise_entry.updated_at::text,
    exercise_entry.updated_by::text,
    exercise_entry.published_at::text
  INTO v_target_updated_at, v_target_updated_by, v_target_published_at
  FROM public.exercises AS exercise_entry
  WHERE exercise_entry.id = 'c4400000-0000-0000-0000-000000000001';
  ...
  IF v_target_updated_at IS NULL
    ...
    OR NOT EXISTS (
      ...
      WHERE progress_entry.user_id =
        ...
        AND progress_entry.chapter_id =
          'c3200000-0000-0000-0000-000000000001'::uuid
        AND progress_entry.theory_percent = 50
        AND progress_entry.exercise_percent = 50
        AND progress_entry.quiz_percent = 100
        AND progress_entry.overall_percent = 66
        AND progress_entry.first_completed_at::text = pg_catalog.current_setting(
          'coditza.slice22_first_completed_at',
          true
        )
    ...
    OR (
      ...
      WHERE progress_entry.chapter_id =
        ...
        AND (
          ...
          OR progress_entry.quiz_percent <> 0
          OR progress_entry.overall_percent <> 0
          OR progress_entry.first_completed_at IS NOT NULL
    ...
    OR NOT EXISTS (
      ...
      WHERE progress_entry.user_id =
        ...
        AND progress_entry.exercise_percent = 0
        AND progress_entry.quiz_percent = 0
        AND progress_entry.overall_percent = 16
        AND progress_entry.first_completed_at IS NULL
        AND progress_entry.completed_at IS NULL
    )
    OR NOT EXISTS (
    ...
    RAISE EXCEPTION 'effective exercise publication did not recalculate every source arm correctly';
  END IF;

  PERFORM pg_catalog.set_config(
    'coditza.slice22_c440_updated_at',
    v_target_updated_at,
    true
  );
  PERFORM pg_catalog.set_config(
    'coditza.slice22_c440_updated_by',
    v_target_updated_by,
    true
  );
  PERFORM pg_catalog.set_config(
    'coditza.slice22_c440_published_at',
    v_target_published_at,
    true
  );
  PERFORM pg_catalog.set_config(
    'coditza.slice22_c440_progress_fingerprint',
    v_progress_fingerprint,
    true
  );
  PERFORM pg_catalog.set_config(
    'coditza.slice22_effective_metric_snapshot',
    v_metric_snapshot::text,
    true
  );
  PERFORM pg_catalog.set_config(
    'coditza.slice22_effective_progress_updated_at',
    v_progress_updated_at_snapshot::text,
    true
  );
END;
$assessment_publish_exercise_effective_snapshot$;
RESET ROLE;

SET LOCAL ROLE service_role;
DO $assessment_publish_exercise_retry_success$
DECLARE
  v_retry record;
BEGIN
  SELECT * INTO v_retry
  FROM public.assessment_publish_exercise(
    ...
    'c4400000-0000-0000-0000-000000000001',
    1,
    'c5010000-0000-0000-0000-000000000041'
  );
  ...
  IF v_retry.response_status <> 200
    ...
    RAISE EXCEPTION 'exercise publication retry did not return its current safe result';
  END IF;
END;
$assessment_publish_exercise_retry_success$;
RESET ROLE;

SET LOCAL ROLE coditza_owner;
DO $assessment_publish_exercise_retry_state_preservation$
DECLARE
  v_progress_fingerprint text;
BEGIN
  SELECT pg_catalog.md5(
  ...
  IF NOT EXISTS (
    ...
    FROM public.exercises AS exercise_entry
    WHERE exercise_entry.id = 'c4400000-0000-0000-0000-000000000001'
      AND exercise_entry.updated_at::text = pg_catalog.current_setting(
        'coditza.slice22_c440_updated_at',
        true
      )
      AND exercise_entry.updated_by::text = pg_catalog.current_setting(
        'coditza.slice22_c440_updated_by',
        true
      )
      AND exercise_entry.published_at::text = pg_catalog.current_setting(
        'coditza.slice22_c440_published_at',
        true
      )
      AND exercise_entry.row_version = 2
    ...
    OR (
      SELECT pg_catalog.count(*)
      FROM private.audit_events AS audit_entry
      WHERE audit_entry.action = 'exercise_published'
        AND audit_entry.entity_type = 'exercise'
        AND audit_entry.entity_id =
          'c4400000-0000-0000-0000-000000000001'::uuid
    ) <> 1 THEN
    RAISE EXCEPTION 'exercise publication retry changed lifecycle metadata, progress, or audit state';
  END IF;
END;
$assessment_publish_exercise_retry_state_preservation$;
RESET ROLE;

SET LOCAL ROLE service_role;
DO $assessment_publish_exercise_retry_and_ineffective_parent_successes$
DECLARE
  v_optional record;
  v_published_under_published_draft record;
  v_published_under_draft_published record;
...
BEGIN
  ...
  FROM public.assessment_publish_exercise(
    ...
    'c4490000-0000-0000-0000-000000000001',
    1,
    'c5010000-0000-0000-0000-000000000042'
  );
  SELECT * INTO v_published_under_published_draft
  FROM public.assessment_publish_exercise(
    'c3000000-0000-0000-0000-000000000005',
    'c4410000-0000-0000-0000-000000000001',
    1,
    'c5010000-0000-0000-0000-000000000043'
  );
  SELECT * INTO v_published_under_draft_published
  FROM public.assessment_publish_exercise(
    'c3000000-0000-0000-0000-000000000004',
    'c4420000-0000-0000-0000-000000000001',
    1,
    'c5010000-0000-0000-0000-000000000044'
  );
  SELECT * INTO v_published_under_draft_draft
  FROM public.assessment_publish_exercise(
    'c3000000-0000-0000-0000-000000000005',
    'c4430000-0000-0000-0000-000000000001',
    1,
    'c5010000-0000-0000-0000-000000000045'
  );

  IF v_optional.response_status <> 200
    OR v_optional.response_body IS DISTINCT FROM pg_catalog.jsonb_build_object(
      'id', 'c4490000-0000-0000-0000-000000000001',
      'rowVersion', 2
    )
    OR v_published_under_published_draft.response_status <> 200
    OR v_published_under_published_draft.response_body IS DISTINCT FROM
      pg_catalog.jsonb_build_object(
        'id', 'c4410000-0000-0000-0000-000000000001',
        'rowVersion', 2
      )
    OR v_published_under_draft_published.response_status <> 200
    OR v_published_under_draft_published.response_body IS DISTINCT FROM
      pg_catalog.jsonb_build_object(
        'id', 'c4420000-0000-0000-0000-000000000001',
        'rowVersion', 2
      )
    OR v_published_under_draft_draft.response_status <> 200
    OR v_published_under_draft_draft.response_body IS DISTINCT FROM
      pg_catalog.jsonb_build_object(
        'id', 'c4430000-0000-0000-0000-000000000001',
        'rowVersion', 2
      ) THEN
    RAISE EXCEPTION 'exercise publication did not preserve retry or ineffective-parent success semantics';
  END IF;
END;
$assessment_publish_exercise_retry_and_ineffective_parent_successes$;
RESET ROLE;

SET LOCAL ROLE coditza_owner;
DO $assessment_publish_exercise_state_preservation$
DECLARE
  v_c440_root_snapshot jsonb;
  v_c440_tree_snapshot jsonb;
  v_parent_snapshot jsonb;
...
BEGIN
  ...
  IF v_c440_root_snapshot IS DISTINCT FROM pg_catalog.current_setting(
      'coditza.slice22_c440_root_snapshot',
      true
    )::jsonb
    OR v_c440_tree_snapshot IS DISTINCT FROM pg_catalog.current_setting(
      'coditza.slice22_c440_tree_snapshot',
      true
    )::jsonb
    ...
    OR NOT v_optional_progress_recalculated THEN
    RAISE EXCEPTION 'exercise publication changed a protected root, definition tree, parent, source, or ineffective-parent snapshot';
  END IF;
  ...
  IF NOT EXISTS (
    ...
    WHERE exercise_entry.id = 'c4400000-0000-0000-0000-000000000001'
      ...
      AND exercise_entry.updated_by =
        'c3000000-0000-0000-0000-000000000004'::uuid
  )
    OR NOT EXISTS (
      SELECT 1
      FROM public.exercises AS exercise_entry
      WHERE exercise_entry.id = 'c4490000-0000-0000-0000-000000000001'
        AND exercise_entry.status = 'published'::public.content_status
        AND exercise_entry.row_version = 2
        AND exercise_entry.definition_version = 1
        AND exercise_entry.published_at IS NOT NULL
        AND exercise_entry.updated_by =
          'c3000000-0000-0000-0000-000000000005'::uuid
    )
    OR NOT EXISTS (
      SELECT 1
      FROM public.exercises AS exercise_entry
      WHERE exercise_entry.id = 'c4410000-0000-0000-0000-000000000001'
        AND exercise_entry.status = 'published'::public.content_status
        AND exercise_entry.row_version = 2
        AND exercise_entry.published_at IS NOT NULL
        AND exercise_entry.updated_by =
    ...
    OR NOT EXISTS (
      SELECT 1
      FROM public.exercises AS exercise_entry
      WHERE exercise_entry.id = 'c4420000-0000-0000-0000-000000000001'
        AND exercise_entry.status = 'published'::public.content_status
        AND exercise_entry.row_version = 2
        AND exercise_entry.published_at IS NOT NULL
        AND exercise_entry.updated_by =
    ...
    OR NOT EXISTS (
      SELECT 1
      FROM public.exercises AS exercise_entry
      WHERE exercise_entry.id = 'c4430000-0000-0000-0000-000000000001'
        AND exercise_entry.status = 'published'::public.content_status
        AND exercise_entry.row_version = 2
        AND exercise_entry.published_at IS NOT NULL
        AND exercise_entry.updated_by =
    ...
    OR NOT EXISTS (
      SELECT 1
      FROM public.exercises AS exercise_entry
      WHERE exercise_entry.id = 'c4460000-0000-0000-0000-000000000001'
        AND exercise_entry.status = 'archived'::public.content_status
        AND exercise_entry.row_version = 2
        AND exercise_entry.definition_version = 1
        AND exercise_entry.published_at IS NULL
    )
    OR (
      SELECT pg_catalog.count(*)
      FROM public.exercises AS exercise_entry
      WHERE exercise_entry.id IN (
        'c4440000-0000-0000-0000-000000000001'::uuid,
        'c4450000-0000-0000-0000-000000000001'::uuid,
        'c44a0000-0000-0000-0000-000000000001'::uuid,
        'c4470000-0000-0000-0000-000000000001'::uuid,
        'c4480000-0000-0000-0000-000000000001'::uuid,
        'c44d0000-0000-0000-0000-000000000001'::uuid
      )
        AND exercise_entry.status = 'draft'::public.content_status
        AND exercise_entry.row_version = 1
        AND exercise_entry.definition_version = 1
    ...
    OR NOT EXISTS (
      SELECT 1
      FROM public.exercises AS exercise_entry
      WHERE exercise_entry.id = 'c44d0000-0000-0000-0000-000000000001'
        AND exercise_entry.position = 96
    )
    OR (
      SELECT pg_catalog.count(*)
      FROM public.exercises AS exercise_entry
    ...
    RAISE EXCEPTION 'exercise publication did not preserve exact lifecycle and validation-denial state';
  END IF;

  IF (
    SELECT pg_catalog.count(*)
    FROM private.audit_events AS audit_entry
    WHERE audit_entry.entity_type = 'exercise'
      AND audit_entry.entity_id IN (
        'c4400000-0000-0000-0000-000000000001'::uuid,
        'c4410000-0000-0000-0000-000000000001'::uuid,
        'c4420000-0000-0000-0000-000000000001'::uuid,
    ...
    OR NOT (
      SELECT pg_catalog.count(*) = 5
        AND pg_catalog.bool_and(
          audit_entry.actor_kind = 'user'
          AND audit_entry.action = 'exercise_published'
          AND audit_entry.entity_type = 'exercise'
          AND audit_entry.changed_fields = ARRAY['status']::text[]
          AND audit_entry.change_summary =
            '{"status":{"before":"draft","after":"published"}}'::jsonb
          ...
          AND (
            (
              ...
              AND audit_entry.entity_id =
                'c4400000-0000-0000-0000-000000000001'::uuid
              AND audit_entry.request_id =
                'c5010000-0000-0000-0000-000000000040'::uuid
            )
            OR (
              audit_entry.actor_user_id =
                'c3000000-0000-0000-0000-000000000005'::uuid
              AND audit_entry.entity_id =
                'c4490000-0000-0000-0000-000000000001'::uuid
              AND audit_entry.request_id =
                'c5010000-0000-0000-0000-000000000042'::uuid
            )
            OR (
              audit_entry.actor_user_id =
                'c3000000-0000-0000-0000-000000000005'::uuid
              AND audit_entry.entity_id =
                'c4410000-0000-0000-0000-000000000001'::uuid
              AND audit_entry.request_id =
                'c5010000-0000-0000-0000-000000000043'::uuid
            )
            OR (
              audit_entry.actor_user_id =
                'c3000000-0000-0000-0000-000000000004'::uuid
              AND audit_entry.entity_id =
                'c4420000-0000-0000-0000-000000000001'::uuid
              AND audit_entry.request_id =
                'c5010000-0000-0000-0000-000000000044'::uuid
            )
            OR (
              audit_entry.actor_user_id =
                'c3000000-0000-0000-0000-000000000005'::uuid
              AND audit_entry.entity_id =
                'c4430000-0000-0000-0000-000000000001'::uuid
              AND audit_entry.request_id =
                'c5010000-0000-0000-0000-000000000045'::uuid
            )
          )
        )
      FROM private.audit_events AS audit_entry
    ...
    OR EXISTS (
      ...
      WHERE audit_entry.request_id IN (
        ...
        'c5010000-0000-0000-0000-000000000009'::uuid,
        'c5010000-0000-0000-0000-000000000010'::uuid,
        'c5010000-0000-0000-0000-000000000011'::uuid,
        'c5010000-0000-0000-0000-000000000012'::uuid,
        'c5010000-0000-0000-0000-000000000013'::uuid,
        'c5010000-0000-0000-0000-000000000014'::uuid,
        'c5010000-0000-0000-0000-000000000015'::uuid,
        ...
        'c5010000-0000-0000-0000-000000000019'::uuid,
        'c5010000-0000-0000-0000-000000000020'::uuid,
        'c5010000-0000-0000-0000-000000000041'::uuid
      )
    )
    OR EXISTS (
      SELECT 1
    ...
    RAISE EXCEPTION 'exercise publication did not preserve audit, replay, or learning-write boundaries';
  END IF;
END;
$assessment_publish_exercise_state_preservation$;
RESET ROLE;
...
-- Slice 24: a chapter becomes learner-visible only after one already-published
-- child of every product category exists. The seed uses owner-only setup so the
-- only chapter lifecycle transitions exercised below are named service-role
-- facade calls.
SET LOCAL ROLE coditza_owner;
DO $curriculum_publish_chapter_seed$
DECLARE
  v_exercise_id uuid;
  v_quiz record;
BEGIN
  ...
  VALUES
    (
      ...
      'c3100000-0000-0000-0000-000000000001',
      'chapter-publication-missing-theory',
      'Chapter missing a published theory section',
      'This valid draft deliberately lacks the theory prerequisite.',
      9700,
      20,
      'c3000000-0000-0000-0000-000000000005',
      'c3000000-0000-0000-0000-000000000005'
    ...
    (
      ...
      'c3100000-0000-0000-0000-000000000001',
      'chapter-publication-missing-exercise',
      'Chapter missing a published exercise',
      'This valid draft deliberately lacks the exercise prerequisite.',
      9701,
      21,
      'c3000000-0000-0000-0000-000000000005',
      'c3000000-0000-0000-0000-000000000005'
    ...
    (
      'c5120000-0000-0000-0000-000000000001',
      'c3100000-0000-0000-0000-000000000001',
      'chapter-publication-missing-quiz',
      'Chapter missing a published quiz',
      'This valid draft deliberately lacks the quiz prerequisite.',
      9702,
      22,
      'c3000000-0000-0000-0000-000000000005',
      'c3000000-0000-0000-0000-000000000005'
    ...
    (
      'c5130000-0000-0000-0000-000000000001',
      'c3100000-0000-0000-0000-000000000001',
      'chapter-publication-optional-readiness',
      'Chapter whose assessment prerequisites are optional',
      'This valid draft proves optional published assessments satisfy readiness.',
      9703,
      23,
      'c3000000-0000-0000-0000-000000000005',
      'c3000000-0000-0000-0000-000000000005'
    ...
    (
      'c5150000-0000-0000-0000-000000000001',
      'c3100000-0000-0000-0000-000000000001',
      'chapter-publication-archived-position-sibling',
      'Archived sibling position sentinel',
      'This archived chapter proves sibling-position readiness includes archives.',
      9704,
      24,
      'c3000000-0000-0000-0000-000000000005',
      'c3000000-0000-0000-0000-000000000005'
  ...
  VALUES
    (
      ...
      'c5100000-0000-0000-0000-000000000001',
      'Draft-only theory prerequisite',
      'A draft theory section must not satisfy chapter publication readiness.',
      0,
      5,
      'c3000000-0000-0000-0000-000000000005',
      'c3000000-0000-0000-0000-000000000005'
    ...
    (
      'c5210000-0000-0000-0000-000000000001',
      'c5110000-0000-0000-0000-000000000001',
      'Published exercise-gap theory',
      'This published theory leaves only the exercise category unavailable.',
      0,
      5,
      'c3000000-0000-0000-0000-000000000005',
      'c3000000-0000-0000-0000-000000000005'
    ...
    (
      'c5220000-0000-0000-0000-000000000001',
      'c5120000-0000-0000-0000-000000000001',
      'Published quiz-gap theory',
      'This published theory leaves only the quiz category unavailable.',
      0,
      5,
      'c3000000-0000-0000-0000-000000000005',
      'c3000000-0000-0000-0000-000000000005'
    ...
    (
      'c5230000-0000-0000-0000-000000000001',
      'c32f0000-0000-0000-0000-000000000001',
      'Archived historical theory source',
      'Its historical completion remains a progress candidate after archival.',
      97,
      5,
      'c3000000-0000-0000-0000-000000000005',
      'c3000000-0000-0000-0000-000000000005'
    ...
    (
      'c5240000-0000-0000-0000-000000000001',
      'c3a60000-0000-0000-0000-000000000001',
      'Archived-parent published theory',
      'A valid published child prevents parent-archive denial from being masked.',
      0,
      5,
      'c3000000-0000-0000-0000-000000000005',
      'c3000000-0000-0000-0000-000000000005'
    ...
    (
      'c5250000-0000-0000-0000-000000000001',
      'c5130000-0000-0000-0000-000000000001',
      'Published optional-readiness theory',
      'A published theory accompanies the sole optional assessment prerequisites.',
      0,
      5,
      'c3000000-0000-0000-0000-000000000005',
      'c3000000-0000-0000-0000-000000000005'
  ...
  VALUES
    ...
    (
      'c5310000-0000-0000-0000-000000000001',
      'c5110000-0000-0000-0000-000000000001',
      'Draft-only exercise prerequisite',
      'Type yes.',
      'short_text'::public.exercise_type,
      0,
      1,
    ...
    (
      'c5320000-0000-0000-0000-000000000001',
      'c5120000-0000-0000-0000-000000000001',
      'Published quiz-gap exercise',
      'Type yes.',
      'short_text'::public.exercise_type,
      0,
      1,
    ...
    (
      'c5330000-0000-0000-0000-000000000001',
      'c32f0000-0000-0000-0000-000000000001',
      'Archived historical exercise source',
      'Type yes.',
      'short_text'::public.exercise_type,
      97,
      1,
    ...
    (
      'c5340000-0000-0000-0000-000000000001',
      'c32f0000-0000-0000-0000-000000000001',
      'Published optional exercise source',
      'Type yes.',
      'short_text'::public.exercise_type,
      98,
      1,
    ...
    (
      'c5350000-0000-0000-0000-000000000001',
      'c3a60000-0000-0000-0000-000000000001',
      'Archived-parent published exercise',
      'Type yes.',
      'short_text'::public.exercise_type,
      0,
      1,
    ...
    (
      'c5360000-0000-0000-0000-000000000001',
      'c5130000-0000-0000-0000-000000000001',
      'Published optional-readiness exercise',
      'Type yes.',
      'short_text'::public.exercise_type,
      0,
      1,
  ...
  FOREACH v_exercise_id IN ARRAY ARRAY[
    'c5300000-0000-0000-0000-000000000001'::uuid,
    'c5310000-0000-0000-0000-000000000001'::uuid,
    'c5320000-0000-0000-0000-000000000001'::uuid,
    'c5330000-0000-0000-0000-000000000001'::uuid,
    'c5340000-0000-0000-0000-000000000001'::uuid,
    'c5350000-0000-0000-0000-000000000001'::uuid,
    'c5360000-0000-0000-0000-000000000001'::uuid
  ] LOOP
    PERFORM pg_catalog.set_config(
      'coditza.assessment_tree_root',
      'exercise:' || v_exercise_id::text,
  ...
  VALUES
    (
      'c5400000-0000-0000-0000-000000000001',
      'c5100000-0000-0000-0000-000000000001',
      'published-theory-gap-quiz',
      'Published theory-gap quiz',
      'Type yes.',
      0,
      70,
    ...
    (
      'c5410000-0000-0000-0000-000000000001',
      'c5110000-0000-0000-0000-000000000001',
      'published-exercise-gap-quiz',
      'Published exercise-gap quiz',
      'Type yes.',
      0,
      70,
    ...
    (
      'c5420000-0000-0000-0000-000000000001',
      'c5120000-0000-0000-0000-000000000001',
      'draft-only-quiz-prerequisite',
      'Draft-only quiz prerequisite',
      'Type yes.',
      0,
      70,
    ...
    (
      'c5430000-0000-0000-0000-000000000001',
      'c32f0000-0000-0000-0000-000000000001',
      'archived-historical-quiz-source',
      'Archived historical quiz source',
      'Type yes.',
      97,
      70,
    ...
    (
      'c5440000-0000-0000-0000-000000000001',
      'c32f0000-0000-0000-0000-000000000001',
      'published-optional-quiz-source',
      'Published optional quiz source',
      'Type yes.',
      98,
      70,
    ...
    (
      'c5450000-0000-0000-0000-000000000001',
      'c3a60000-0000-0000-0000-000000000001',
      'archived-parent-published-quiz',
      'Archived-parent published quiz',
      'Type yes.',
      0,
      70,
    ...
    (
      'c5460000-0000-0000-0000-000000000001',
      'c5130000-0000-0000-0000-000000000001',
      'published-optional-readiness-quiz',
      'Published optional-readiness quiz',
      'Type yes.',
      0,
      70,
  ...
  FOR v_quiz IN
    ...
    FROM (
      VALUES
        (
          'c5400000-0000-0000-0000-000000000001'::uuid,
          'c5500000-0000-0000-0000-000000000001'::uuid
        ),
        (
          'c5410000-0000-0000-0000-000000000001'::uuid,
          'c5510000-0000-0000-0000-000000000001'::uuid
        ),
        (
          'c5420000-0000-0000-0000-000000000001'::uuid,
          'c5520000-0000-0000-0000-000000000001'::uuid
        ),
        (
          'c5430000-0000-0000-0000-000000000001'::uuid,
          'c5530000-0000-0000-0000-000000000001'::uuid
        ),
        (
          'c5440000-0000-0000-0000-000000000001'::uuid,
          'c5540000-0000-0000-0000-000000000001'::uuid
        ),
        (
          'c5450000-0000-0000-0000-000000000001'::uuid,
          'c5550000-0000-0000-0000-000000000001'::uuid
        ),
        (
          'c5460000-0000-0000-0000-000000000001'::uuid,
          'c5560000-0000-0000-0000-000000000001'::uuid
        )
    ) AS quiz_fixture(quiz_id, question_id)
  LOOP
    PERFORM pg_catalog.set_config(
      'coditza.assessment_tree_root',
      'quiz:' || v_quiz.quiz_id::text,
      true
    );
    INSERT INTO public.quiz_questions (
      id,
  ...
  SET
    ...
    updated_by = 'c3000000-0000-0000-0000-000000000005'
  WHERE id IN (
    'c5210000-0000-0000-0000-000000000001'::uuid,
    'c5220000-0000-0000-0000-000000000001'::uuid,
    'c5240000-0000-0000-0000-000000000001'::uuid,
    'c5250000-0000-0000-0000-000000000001'::uuid
  );
  ...
  PERFORM pg_catalog.set_config(
    'coditza.learning_write',
    'theory:c3000000-0000-0000-0000-000000000007:c4310000-0000-0000-0000-000000000001',
    true
  );
  INSERT INTO public.theory_section_completions (
    user_id,
  ...
  PERFORM pg_catalog.set_config(
    'coditza.learning_write',
    'theory:c3000000-0000-0000-0000-000000000010:c5230000-0000-0000-0000-000000000001',
    true
  );
  INSERT INTO public.theory_section_completions (
    user_id,
  ...
  VALUES
    (
      'c5600000-0000-0000-0000-000000000001',
      'c3000000-0000-0000-0000-000000000001',
      'c5340000-0000-0000-0000-000000000001',
      1,
      '{"text":"yes"}'::jsonb,
    ...
    (
      'c5620000-0000-0000-0000-000000000001',
      'c3000000-0000-0000-0000-000000000008',
      'c4410000-0000-0000-0000-000000000001',
      1,
      '{"text":"yes"}'::jsonb,
    ...
    (
      'c5640000-0000-0000-0000-000000000001',
      'c3000000-0000-0000-0000-000000000011',
      'c5330000-0000-0000-0000-000000000001',
      1,
      '{"text":"yes"}'::jsonb,
  ...
  VALUES
    (
      'c5610000-0000-0000-0000-000000000001',
      'c3000000-0000-0000-0000-000000000002',
      'c5440000-0000-0000-0000-000000000001',
      1,
      1,
    ...
    (
      'c5630000-0000-0000-0000-000000000001',
      'c3000000-0000-0000-0000-000000000009',
      'c4610000-0000-0000-0000-000000000001',
      1,
      1,
    ...
    (
      'c5650000-0000-0000-0000-000000000001',
      'c3000000-0000-0000-0000-000000000012',
      'c5430000-0000-0000-0000-000000000001',
      1,
      1,
  ...
  SET
    status = 'archived'::public.content_status,
    updated_by = 'c3000000-0000-0000-0000-000000000005'
  WHERE id = 'c5230000-0000-0000-0000-000000000001';
  UPDATE public.exercises
  SET
    status = 'archived'::public.content_status,
    updated_by = 'c3000000-0000-0000-0000-000000000005'
  WHERE id = 'c5330000-0000-0000-0000-000000000001';
  UPDATE public.quizzes
  SET
    status = 'archived'::public.content_status,
    updated_by = 'c3000000-0000-0000-0000-000000000005'
  WHERE id = 'c5430000-0000-0000-0000-000000000001';

  UPDATE public.chapters
  SET
    status = 'archived'::public.content_status,
    updated_by = 'c3000000-0000-0000-0000-000000000005'
  WHERE id = 'c5150000-0000-0000-0000-000000000001';
END;
$curriculum_publish_chapter_seed$;

DO $curriculum_publish_chapter_initial_snapshot$
DECLARE
  v_root_static jsonb;
  v_module_snapshot jsonb;
  v_c420_root_snapshot jsonb;
  v_descendant_snapshot jsonb;
  v_source_fingerprint text;
  v_ineffective_progress_snapshot jsonb;
  v_c003_updated_at text;
  v_affected_user_ids jsonb;
BEGIN
  SELECT pg_catalog.jsonb_object_agg(
    chapter_entry.id::text,
    pg_catalog.to_jsonb(chapter_entry)
      - 'status'
      - 'row_version'
      - 'published_at'
  ...
  SELECT COALESCE(
    pg_catalog.jsonb_agg(pg_catalog.to_jsonb(module_entry) ORDER BY module_entry.id),
    '[]'::jsonb
  )
  INTO v_module_snapshot
  FROM public.modules AS module_entry
  ...
  SELECT pg_catalog.to_jsonb(chapter_entry)
  INTO v_c420_root_snapshot
  FROM public.chapters AS chapter_entry
  WHERE chapter_entry.id = 'c4200000-0000-0000-0000-000000000001';
    ...
    pg_catalog.jsonb_build_object(
      ...
      COALESCE(
        (
          ...
          FROM public.theory_sections AS theory_entry
          WHERE theory_entry.chapter_id = chapter_entry.id
        ),
        '[]'::jsonb
      ),
      'exercises',
      COALESCE(
        (
          SELECT pg_catalog.jsonb_agg(
            pg_catalog.to_jsonb(exercise_entry)
            ORDER BY exercise_entry.id
          )
          FROM public.exercises AS exercise_entry
          WHERE exercise_entry.chapter_id = chapter_entry.id
        ),
        '[]'::jsonb
      ),
      'exerciseOptions',
      ...
      COALESCE(
        (
          SELECT pg_catalog.jsonb_agg(
            pg_catalog.to_jsonb(answer_key)
            ORDER BY answer_key.exercise_id
          )
          FROM private.exercise_answer_keys AS answer_key
          JOIN public.exercises AS exercise_entry
            ON exercise_entry.id = answer_key.exercise_id
      ...
      COALESCE(
        (
          SELECT pg_catalog.jsonb_agg(
            pg_catalog.to_jsonb(quiz_entry)
            ORDER BY quiz_entry.id
          )
          FROM public.quizzes AS quiz_entry
          WHERE quiz_entry.chapter_id = chapter_entry.id
        ),
        '[]'::jsonb
      ),
      'quizQuestions',
  ...
  SELECT pg_catalog.jsonb_object_agg(
    ...
    COALESCE(
      (
        ...
        FROM public.chapter_progress AS progress_entry
        WHERE progress_entry.chapter_id = chapter_entry.id
      ),
      '[]'::jsonb
    )
  )
  ...
  SELECT progress_entry.updated_at::text
  INTO v_c003_updated_at
  FROM public.chapter_progress AS progress_entry
  WHERE progress_entry.user_id =
      'c3000000-0000-0000-0000-000000000003'::uuid
    AND progress_entry.chapter_id =
  ...
  IF v_root_static IS NULL
    OR v_module_snapshot IS NULL
    OR v_c420_root_snapshot IS NULL
    OR v_descendant_snapshot IS NULL
    OR v_source_fingerprint IS NULL
    OR v_ineffective_progress_snapshot IS NULL
    OR v_c003_updated_at IS NULL
    OR v_affected_user_ids IS DISTINCT FROM pg_catalog.jsonb_build_array(
      'c3000000-0000-0000-0000-000000000001',
      'c3000000-0000-0000-0000-000000000002',
      'c3000000-0000-0000-0000-000000000003',
    ...
    RAISE EXCEPTION 'chapter publication fixture is incomplete';
  END IF;

  PERFORM pg_catalog.set_config(
    'coditza.slice24_root_static',
    v_root_static::text,
    true
  );
  PERFORM pg_catalog.set_config(
    'coditza.slice24_modules_snapshot',
    v_module_snapshot::text,
    true
  );
  PERFORM pg_catalog.set_config(
    'coditza.slice24_c420_root_snapshot',
    v_c420_root_snapshot::text,
    true
  );
  PERFORM pg_catalog.set_config(
    'coditza.slice24_descendant_snapshot',
    v_descendant_snapshot::text,
    true
  );
  PERFORM pg_catalog.set_config(
    'coditza.slice24_source_fingerprint',
    v_source_fingerprint,
    true
  );
  PERFORM pg_catalog.set_config(
    'coditza.slice24_ineffective_progress_snapshot',
    v_ineffective_progress_snapshot::text,
    true
  );
  PERFORM pg_catalog.set_config(
    'coditza.slice24_c003_updated_at',
    v_c003_updated_at,
    true
  );
END;
$curriculum_publish_chapter_initial_snapshot$;
RESET ROLE;

-- The explicit sibling-position test must fail inside the facade, before the
-- deferred table constraint can observe a lifecycle write.
SET LOCAL ROLE coditza_owner;
DO $curriculum_publish_chapter_position_readiness_denial$
DECLARE
  v_duplicate_position integer;
  v_rejected boolean := false;
BEGIN
  SELECT chapter_entry.position
  INTO v_duplicate_position
  FROM public.chapters AS chapter_entry
  WHERE chapter_entry.id = 'c5150000-0000-0000-0000-000000000001'
    AND chapter_entry.status = 'archived'::public.content_status;

  IF v_duplicate_position IS NULL THEN
    RAISE EXCEPTION 'chapter publication duplicate-position fixture is incomplete';
  END IF;
  ...
  BEGIN
    ...
    WHERE id = 'c32f0000-0000-0000-0000-000000000001';
    ...
    FROM public.curriculum_publish_chapter(
      ...
      'c32f0000-0000-0000-0000-000000000001',
      3,
      'c5030000-0000-0000-0000-000000000002'
    );
  EXCEPTION WHEN raise_exception THEN
    v_rejected := true;
  END;
  ...
  IF NOT v_rejected THEN
    RAISE EXCEPTION 'chapter publication did not reject a deferred duplicate sibling position itself';
  END IF;
END;
$curriculum_publish_chapter_position_readiness_denial$;
RESET ROLE;

SET LOCAL ROLE service_role;
DO $curriculum_publish_chapter_validation$
DECLARE
  v_case record;
  v_rejected boolean;
BEGIN
    ...
    FROM (
      VALUES
        (
          ...
          'c32f0000-0000-0000-0000-000000000001'::uuid,
          2::integer,
          'c5030000-0000-0000-0000-000000000003'::uuid
        ),
        (
          ...
          'c32f0000-0000-0000-0000-000000000001'::uuid,
          2::integer,
          'c5030000-0000-0000-0000-000000000004'::uuid
        ),
        (
          'null actor'::text,
          NULL::uuid,
          'c32f0000-0000-0000-0000-000000000001'::uuid,
          2::integer,
          'c5030000-0000-0000-0000-000000000005'::uuid
        ),
        (
          'missing actor'::text,
          'c3000000-0000-0000-0000-000000000999'::uuid,
          'c32f0000-0000-0000-0000-000000000001'::uuid,
          2::integer,
          'c5030000-0000-0000-0000-000000000006'::uuid
        ),
        (
          'null chapter'::text,
          'c3000000-0000-0000-0000-000000000005'::uuid,
          NULL::uuid,
          2::integer,
          'c5030000-0000-0000-0000-000000000007'::uuid
        ),
        (
          'missing chapter'::text,
          'c3000000-0000-0000-0000-000000000005'::uuid,
          'c5140000-0000-0000-0000-000000000001'::uuid,
          2::integer,
          'c5030000-0000-0000-0000-000000000008'::uuid
        ),
        (
          ...
          'c32f0000-0000-0000-0000-000000000001'::uuid,
          NULL::integer,
          'c5030000-0000-0000-0000-000000000009'::uuid
        ),
        (
          ...
          'c32f0000-0000-0000-0000-000000000001'::uuid,
          0::integer,
          'c5030000-0000-0000-0000-000000000010'::uuid
        ),
        (
          ...
          'c32f0000-0000-0000-0000-000000000001'::uuid,
          -1::integer,
          'c5030000-0000-0000-0000-000000000011'::uuid
        ),
        (
        ...
        (
          ...
          'c32f0000-0000-0000-0000-000000000001'::uuid,
          1::integer,
          'c5030000-0000-0000-0000-000000000013'::uuid
        ),
        (
          'missing published theory category'::text,
          'c3000000-0000-0000-0000-000000000005'::uuid,
          'c5100000-0000-0000-0000-000000000001'::uuid,
          1::integer,
          'c5030000-0000-0000-0000-000000000014'::uuid
        ),
        (
          'missing published exercise category'::text,
          'c3000000-0000-0000-0000-000000000005'::uuid,
          'c5110000-0000-0000-0000-000000000001'::uuid,
          1::integer,
          'c5030000-0000-0000-0000-000000000015'::uuid
        ),
        (
          'missing published quiz category'::text,
          'c3000000-0000-0000-0000-000000000005'::uuid,
          'c5120000-0000-0000-0000-000000000001'::uuid,
          1::integer,
          'c5030000-0000-0000-0000-000000000016'::uuid
        ),
        (
          ...
          'c32c0000-0000-0000-0000-000000000001'::uuid,
          2::integer,
          'c5030000-0000-0000-0000-000000000017'::uuid
        ),
        (
          'draft chapter under archived module'::text,
          'c3000000-0000-0000-0000-000000000005'::uuid,
          'c3310000-0000-0000-0000-000000000001'::uuid,
          1::integer,
          'c5030000-0000-0000-0000-000000000018'::uuid
        ),
        (
          'published chapter under archived module'::text,
          'c3000000-0000-0000-0000-000000000005'::uuid,
          'c3a60000-0000-0000-0000-000000000001'::uuid,
          2::integer,
          'c5030000-0000-0000-0000-000000000019'::uuid
        )
    ) AS validation_case(
      label,
      actor_user_id,
  ...
  LOOP
    ...
    END;
    IF NOT v_rejected THEN
      RAISE EXCEPTION 'chapter publication unexpectedly accepted validation case: %', v_case.label;
    END IF;
  END LOOP;
END;
$curriculum_publish_chapter_validation$;
RESET ROLE;

SET LOCAL ROLE service_role;
DO $curriculum_publish_chapter_effective_success$
DECLARE
  v_result record;
BEGIN
  SELECT *
  ...
  FROM public.curriculum_publish_chapter(
    ...
    'c32f0000-0000-0000-0000-000000000001',
    2,
    'c5030000-0000-0000-0000-000000000040'
  );

  IF v_result.response_status <> 200
    OR v_result.response_body IS DISTINCT FROM pg_catalog.jsonb_build_object(
      'id', 'c32f0000-0000-0000-0000-000000000001',
      'rowVersion', 3
    ) THEN
    RAISE EXCEPTION 'effective-parent chapter publication did not return its single lifecycle response';
  END IF;
END;
$curriculum_publish_chapter_effective_success$;
RESET ROLE;

SET LOCAL ROLE coditza_owner;
DO $curriculum_publish_chapter_post_success_snapshot$
DECLARE
...
BEGIN
  ...
  IF (
    ...
    RAISE EXCEPTION 'effective chapter publication did not reconcile every source candidate';
  END IF;

  PERFORM pg_catalog.set_config(
    'coditza.slice24_effective_progress_snapshot',
    v_progress_snapshot::text,
    true
  );
END;
$curriculum_publish_chapter_post_success_snapshot$;
RESET ROLE;

SET LOCAL ROLE service_role;
DO $curriculum_publish_chapter_retries_and_draft_parent$
DECLARE
  v_effective_retry record;
  v_draft_parent_success record;
  v_draft_parent_retry record;
  v_published_draft_parent_retry record;
  v_optional_readiness_success record;
BEGIN
  SELECT *
  INTO v_effective_retry
  FROM public.curriculum_publish_chapter(
    'c3000000-0000-0000-0000-000000000005',
    'c32f0000-0000-0000-0000-000000000001',
    1,
    'c5030000-0000-0000-0000-000000000041'
  );

  SELECT *
  INTO v_draft_parent_success
  FROM public.curriculum_publish_chapter(
    'c3000000-0000-0000-0000-000000000005',
    'c32e0000-0000-0000-0000-000000000001',
    2,
    'c5030000-0000-0000-0000-000000000042'
  );

  SELECT *
  INTO v_draft_parent_retry
  FROM public.curriculum_publish_chapter(
    'c3000000-0000-0000-0000-000000000005',
    'c32e0000-0000-0000-0000-000000000001',
    1,
    'c5030000-0000-0000-0000-000000000043'
  );

  SELECT *
  INTO v_published_draft_parent_retry
  FROM public.curriculum_publish_chapter(
    'c3000000-0000-0000-0000-000000000005',
    'c4200000-0000-0000-0000-000000000001',
    999,
    'c5030000-0000-0000-0000-000000000044'
  );

  SELECT *
  INTO v_optional_readiness_success
  FROM public.curriculum_publish_chapter(
    'c3000000-0000-0000-0000-000000000005',
    'c5130000-0000-0000-0000-000000000001',
    1,
    'c5030000-0000-0000-0000-000000000045'
  );

  IF v_effective_retry.response_status <> 200
    OR v_effective_retry.response_body IS DISTINCT FROM pg_catalog.jsonb_build_object(
      'id', 'c32f0000-0000-0000-0000-000000000001',
      'rowVersion', 3
    )
    OR v_draft_parent_success.response_status <> 200
    OR v_draft_parent_success.response_body IS DISTINCT FROM
      pg_catalog.jsonb_build_object(
        'id', 'c32e0000-0000-0000-0000-000000000001',
        'rowVersion', 3
      )
    OR v_draft_parent_retry.response_status <> 200
    OR v_draft_parent_retry.response_body IS DISTINCT FROM
      pg_catalog.jsonb_build_object(
        'id', 'c32e0000-0000-0000-0000-000000000001',
        'rowVersion', 3
      )
    OR v_published_draft_parent_retry.response_status <> 200
    OR v_published_draft_parent_retry.response_body IS DISTINCT FROM
      pg_catalog.jsonb_build_object(
        'id', 'c4200000-0000-0000-0000-000000000001',
        'rowVersion', 2
      )
    OR v_optional_readiness_success.response_status <> 200
    OR v_optional_readiness_success.response_body IS DISTINCT FROM
      pg_catalog.jsonb_build_object(
        'id', 'c5130000-0000-0000-0000-000000000001',
        'rowVersion', 2
      ) THEN
    RAISE EXCEPTION 'chapter publication did not preserve state-based retry or draft-parent publication semantics';
  END IF;
END;
$curriculum_publish_chapter_retries_and_draft_parent$;
RESET ROLE;

SET LOCAL ROLE coditza_owner;
DO $curriculum_publish_chapter_state_preservation$
DECLARE
  v_root_static jsonb;
  v_module_snapshot jsonb;
  v_c420_root_snapshot jsonb;
  ...
  v_source_fingerprint text;
  v_ineffective_progress_snapshot jsonb;
  v_effective_progress_snapshot jsonb;
  v_effective_metrics jsonb;
  v_c003_recalculated boolean;
BEGIN
  SELECT pg_catalog.jsonb_object_agg(
    chapter_entry.id::text,
    pg_catalog.to_jsonb(chapter_entry)
  ...
  INTO v_effective_progress_snapshot
  FROM public.chapter_progress AS progress_entry
  WHERE progress_entry.chapter_id =
    'c32f0000-0000-0000-0000-000000000001'::uuid;
  ...
  INTO v_effective_metrics
  FROM public.chapter_progress AS progress_entry
  WHERE progress_entry.chapter_id =
    'c32f0000-0000-0000-0000-000000000001'::uuid;

  SELECT progress_entry.updated_at > (
    pg_catalog.current_setting('coditza.slice24_c003_updated_at', true)
  )::timestamptz
  INTO v_c003_recalculated
  FROM public.chapter_progress AS progress_entry
  WHERE progress_entry.user_id =
      'c3000000-0000-0000-0000-000000000003'::uuid
    AND progress_entry.chapter_id =
  ...
  IF v_root_static IS DISTINCT FROM pg_catalog.current_setting(
      'coditza.slice24_root_static',
      true
    )::jsonb
    OR v_module_snapshot IS DISTINCT FROM pg_catalog.current_setting(
      'coditza.slice24_modules_snapshot',
      true
    )::jsonb
    OR v_c420_root_snapshot IS DISTINCT FROM pg_catalog.current_setting(
      'coditza.slice24_c420_root_snapshot',
      true
    )::jsonb
    ...
    OR v_effective_progress_snapshot IS DISTINCT FROM pg_catalog.current_setting(
      'coditza.slice24_effective_progress_snapshot',
      true
    )::jsonb
    OR NOT v_c003_recalculated
    OR v_effective_metrics IS DISTINCT FROM pg_catalog.jsonb_build_array(
      pg_catalog.jsonb_build_object(
        'userId', 'c3000000-0000-0000-0000-000000000001',
        'theoryPercent', 0,
        'exercisePercent', 0,
        'quizPercent', 0,
        'overallPercent', 0,
      ...
      pg_catalog.jsonb_build_object(
        'userId', 'c3000000-0000-0000-0000-000000000002',
        'theoryPercent', 0,
        'exercisePercent', 0,
        'quizPercent', 0,
        'overallPercent', 0,
      ...
      pg_catalog.jsonb_build_object(
        'userId', 'c3000000-0000-0000-0000-000000000003',
        'theoryPercent', 0,
        'exercisePercent', 0,
        'quizPercent', 0,
        'overallPercent', 0,
      ...
      pg_catalog.jsonb_build_object(
        'userId', 'c3000000-0000-0000-0000-000000000007',
        'theoryPercent', 100,
        'exercisePercent', 0,
        'quizPercent', 0,
        'overallPercent', 33,
      ...
      pg_catalog.jsonb_build_object(
        'userId', 'c3000000-0000-0000-0000-000000000008',
        'theoryPercent', 0,
        'exercisePercent', 100,
        'quizPercent', 0,
        'overallPercent', 33,
      ...
      pg_catalog.jsonb_build_object(
        'userId', 'c3000000-0000-0000-0000-000000000009',
        'theoryPercent', 0,
        'exercisePercent', 0,
        'quizPercent', 100,
        'overallPercent', 33,
      ...
      pg_catalog.jsonb_build_object(
        'userId', 'c3000000-0000-0000-0000-000000000010',
        'theoryPercent', 0,
        'exercisePercent', 0,
        'quizPercent', 0,
        'overallPercent', 0,
      ...
      pg_catalog.jsonb_build_object(
        'userId', 'c3000000-0000-0000-0000-000000000011',
        'theoryPercent', 0,
        'exercisePercent', 0,
        'quizPercent', 0,
        'overallPercent', 0,
      ...
      pg_catalog.jsonb_build_object(
        'userId', 'c3000000-0000-0000-0000-000000000012',
        'theoryPercent', 0,
        'exercisePercent', 0,
        'quizPercent', 0,
        'overallPercent', 0,
    ...
    OR NOT EXISTS (
      ...
      FROM public.chapters AS chapter_entry
      WHERE chapter_entry.id =
          'c5130000-0000-0000-0000-000000000001'::uuid
        AND chapter_entry.status = 'published'::public.content_status
        AND chapter_entry.row_version = 2
        AND chapter_entry.published_at IS NOT NULL
        AND chapter_entry.updated_by =
    ...
    OR (
      ...
      WHERE exercise_entry.chapter_id =
          'c5130000-0000-0000-0000-000000000001'::uuid
        AND exercise_entry.status = 'published'::public.content_status
        AND NOT exercise_entry.is_required
    ) <> 1
    OR (
      SELECT pg_catalog.count(*)
      FROM public.quizzes AS quiz_entry
      WHERE quiz_entry.chapter_id =
          'c5130000-0000-0000-0000-000000000001'::uuid
        AND quiz_entry.status = 'published'::public.content_status
        AND NOT quiz_entry.is_required
    ) <> 1
    OR EXISTS (
      SELECT 1
      FROM public.chapter_progress AS progress_entry
    ...
    OR NOT EXISTS (
      ...
      FROM public.chapters AS chapter_entry
      WHERE chapter_entry.id =
          'c5150000-0000-0000-0000-000000000001'::uuid
        AND chapter_entry.status = 'archived'::public.content_status
        AND chapter_entry.row_version = 2
        AND chapter_entry.position = 9704
    )
    OR NOT EXISTS (
      SELECT 1
      FROM public.chapters AS chapter_entry
    ...
    OR (
      SELECT pg_catalog.count(*)
      FROM private.audit_events AS audit_entry
      WHERE audit_entry.action = 'chapter_published'
        AND audit_entry.entity_type = 'chapter'
        AND audit_entry.entity_id IN (
          'c32f0000-0000-0000-0000-000000000001'::uuid,
          'c32e0000-0000-0000-0000-000000000001'::uuid,
    ...
    OR NOT EXISTS (
      ...
      WHERE audit_entry.actor_kind = 'user'
        AND audit_entry.actor_user_id =
          'c3000000-0000-0000-0000-000000000004'::uuid
        AND audit_entry.action = 'chapter_published'
        AND audit_entry.entity_type = 'chapter'
        AND audit_entry.entity_id =
          'c32f0000-0000-0000-0000-000000000001'::uuid
        AND audit_entry.changed_fields = ARRAY['status']::text[]
        ...
        AND audit_entry.reason IS NULL
        AND audit_entry.request_id =
          'c5030000-0000-0000-0000-000000000040'::uuid
    )
    OR NOT EXISTS (
      SELECT 1
      FROM private.audit_events AS audit_entry
      WHERE audit_entry.actor_kind = 'user'
        ...
        AND audit_entry.reason IS NULL
        AND audit_entry.request_id =
          'c5030000-0000-0000-0000-000000000042'::uuid
    )
    OR NOT EXISTS (
      SELECT 1
      FROM private.audit_events AS audit_entry
      WHERE audit_entry.actor_kind = 'user'
        ...
        AND audit_entry.reason IS NULL
        AND audit_entry.request_id =
          'c5030000-0000-0000-0000-000000000045'::uuid
    )
    OR EXISTS (
      SELECT 1
      FROM private.audit_events AS audit_entry
      WHERE audit_entry.request_id IN (
        'c5030000-0000-0000-0000-000000000001'::uuid,
        'c5030000-0000-0000-0000-000000000002'::uuid,
        'c5030000-0000-0000-0000-000000000003'::uuid,
        'c5030000-0000-0000-0000-000000000004'::uuid,
        'c5030000-0000-0000-0000-000000000005'::uuid,
        'c5030000-0000-0000-0000-000000000006'::uuid,
        ...
        'c5030000-0000-0000-0000-000000000018'::uuid,
        'c5030000-0000-0000-0000-000000000019'::uuid,
        'c5030000-0000-0000-0000-000000000041'::uuid,
        'c5030000-0000-0000-0000-000000000043'::uuid,
        'c5030000-0000-0000-0000-000000000044'::uuid
      )
    )
    OR EXISTS (
      SELECT 1
    ...
    RAISE EXCEPTION 'chapter publication changed protected state, missed progress candidates, or wrote outside its lifecycle contract';
  END IF;
END;
$curriculum_publish_chapter_state_preservation$;
RESET ROLE;
