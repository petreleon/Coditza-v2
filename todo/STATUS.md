...
- [SUP-FUNCTIONS-001 theory-section publication slice report](../docs/implementation/SUP-FUNCTIONS-001-slice-21.md);
  ...
  local/Docker proof.
- [SUP-FUNCTIONS-001 exercise publication slice report](../docs/implementation/SUP-FUNCTIONS-001-slice-22.md);
  a service-role-only facade now publishes one validated exercise draft with
  canonical hierarchy and UUID-ordered progress locks, fails closed for Python
