...
hosted selection. G1 remains passed; SUP-LOCAL-001/002 are complete and
SUP-PRIMITIVES-001 is the sole next local task. Real application modules and
all hosted configuration remain deferred.
