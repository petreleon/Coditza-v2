...
hosted selection. G1 remains passed; SUP-LOCAL-001/002 and
SUP-PRIMITIVES-001 are complete, and SUP-AUTH-001 is the sole next local task.
Real application modules and all hosted configuration remain deferred.
