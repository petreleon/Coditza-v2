...
Implementation note (2026-07-29): eleven forward-only slices are present:
...
PATCH idempotency. They are documented in
...
[slice 11](../../docs/implementation/SUP-FUNCTIONS-001-slice-11.md).
