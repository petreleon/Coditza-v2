...
Implementation note (2026-07-29): fifteen forward-only slices are present:
...
without invented replay. They are documented in
...
[slice 15](../../docs/implementation/SUP-FUNCTIONS-001-slice-15.md).
