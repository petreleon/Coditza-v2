...
Implementation note (2026-07-29): ten forward-only slices are present:
...
invented PATCH idempotency. They are documented in
...
[slice 10](../../docs/implementation/SUP-FUNCTIONS-001-slice-10.md).
