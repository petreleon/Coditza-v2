...
| SUP-AUTH-001 | local | primitives | [Auth schema](03-supabase/06-auth-profiles-and-roles.md) — profile trigger migration/tests | learner/default/fallback/cascade tests | next |
