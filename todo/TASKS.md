...
| SUP-DATA-002 | local | core hierarchy | [assessment schema](03-supabase/03-assessment-schema.md) — assessment/private migration/tests | key isolation/definition/immutability tests | next |
