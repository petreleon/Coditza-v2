...
| ID | Mode | Hard prerequisite | Owner / permitted scope | Minimum evidence | Status |
| --- | --- | --- | --- | --- | --- |
| OPS-VERCEL-001 | review | G1 + ARC-DESIGN-001 + PRD-WASM-001 + user Vercel direction | [deployment topology](07-operations/01-deployment-environments.md) — Vercel/supplemental-host ADR only | [ADR 0005](../docs/adr/0005-vercel-public-api-and-private-grader-topology.md) + [five-plane matrix](../docs/implementation/OPS-VERCEL-001-capability-matrix.md); no resource | complete |
| ARC-WASM-001 | local | G1 + PRD-WASM-001 + FOUND-001 + OPS-VERCEL-001; owns DEC-032's local-proof portion | [WASM architecture](02-architecture/07-python-wasm-verification.md) — ADR/runtime lock/threat model | [ADR 0006](../docs/adr/0006-local-python-wasm-reference-proof.md) + [local public-proof report](../docs/implementation/ARC-WASM-001.md); hosted launcher remains unselected | complete |
| SUP-LOCAL-001 | local | G1 + Docker engine | [local Supabase](03-supabase/01-local-cli-and-migrations.md) — CLI config | [local start/status/capture/stop report](../docs/implementation/SUP-LOCAL-001.md); no remote | complete |
| SUP-LOCAL-002 | local | SUP-LOCAL-001 | [local Supabase](03-supabase/01-local-cli-and-migrations.md) — migrations/seed commands | [two protected identical local resets, exact history, empty diff/lint, and no remote](../docs/implementation/SUP-LOCAL-002.md) | complete |
...
| SUP-PRIMITIVES-001 | local | migration discipline | [local Supabase](03-supabase/01-local-cli-and-migrations.md) — primitive migration | [local migration, pgTAP, reset, drift, and privilege report](../docs/implementation/SUP-PRIMITIVES-001.md) | complete |
| SUP-AUTH-001 | local | primitives | [Auth schema](03-supabase/06-auth-profiles-and-roles.md) — profile trigger migration/tests | [local profile migration, pgTAP, reset, drift, and privilege report](../docs/implementation/SUP-AUTH-001.md) | complete |
| PRD-ROLE-001 | local | SUP-AUTH-001 | [roles](01-product/01-roles-and-permissions.md) — requirement verification | [default-learner requirement verification report](../docs/implementation/PRD-ROLE-001.md) | complete |
...
| SUP-DATA-001 | local | Auth/profile primitives | [core schema](03-supabase/02-core-content-schema.md) — hierarchy migration/tests | [constraints, indexes, hierarchy, and protected local test evidence](../docs/implementation/SUP-DATA-001.md) | complete |
| SUP-DATA-002 | local | core hierarchy | [assessment schema](03-supabase/03-assessment-schema.md) — assessment/private migration/tests | [key isolation/definition/immutability proof](../docs/implementation/SUP-DATA-002.md) | complete |
| SUP-DATA-003 | local | assessments | [learning schema](03-supabase/04-learning-progress-schema.md) — learning/audit migration/tests | [attempt/progress/privacy constraints](../docs/implementation/SUP-DATA-003.md) | complete |
| ARC-SEC-003 | local | audit table | [security flow](02-architecture/04-data-flow-and-security.md) — audit behavior | [append-only sanitized user/system events](../docs/implementation/ARC-SEC-003.md) | complete |
| SUP-FUNCTIONS-001 | local | all owned tables | [functions](03-supabase/05-functions-constraints-indexes.md) — workflow migration/tests | learner mutation/progress/history, locked staff authorization, draft module/chapter/theory authoring, scalar draft-exercise, complete draft-quiz tree/replay/audit, scalar draft-exercise PATCH/version/history, draft-quiz root PATCH/version/history, draft-quiz definition replacement/version/mapping, protected scalar draft-exercise/draft-quiz authoring reads, draft-module/draft-chapter/draft-theory-section PATCH/version/redacted-audit, published-module/published-chapter/published-theory-section correction/version/redacted-audit, and theory-section, exercise, quiz, chapter, and module publication/version/progress/audit slices verified; remaining authoring/operations families and true concurrency evidence | in progress |
...
| SUP-AUTH-002 | local | profile/audit/function-security foundation | [Auth schema](03-supabase/06-auth-profiles-and-roles.md) — owns role-control function/tests | last-admin concurrent protection | not started |
