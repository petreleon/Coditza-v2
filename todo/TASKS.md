...
| SUP-FUNCTIONS-001 | local | all owned tables | [functions](03-supabase/05-functions-constraints-indexes.md) — workflow migration/tests | learner mutation, progress, and assessment-history slices verified; remaining authoring/operations families, atomicity, and true concurrency evidence | in progress |
