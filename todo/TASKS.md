...
| SUP-DATA-001 | local | Auth/profile primitives | [core schema](03-supabase/02-core-content-schema.md) — hierarchy migration/tests | constraints/indexes/hierarchy tests | next |
