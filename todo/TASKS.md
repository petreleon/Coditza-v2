...
| SUP-FUNCTIONS-001 | local | all owned tables | [functions](03-supabase/05-functions-constraints-indexes.md) — workflow migration/tests | learner mutation/progress/history, locked staff authorization, and draft module/chapter/theory authoring/replay/audit slices verified; remaining authoring/operations families, atomicity, and true concurrency evidence | in progress |
