...
| SUP-PRIMITIVES-001 | local | migration discipline | [local Supabase](03-supabase/01-local-cli-and-migrations.md) — primitive migration | schemas/enums/extensions/default grants tests | next |
