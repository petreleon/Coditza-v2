...
| ARC-WASM-001 | local | G1 + PRD-WASM-001 + FOUND-001 + OPS-VERCEL-001; owns DEC-032 resolution | [WASM architecture](02-architecture/07-python-wasm-verification.md) — ADR/runtime lock/threat model | exact asset digests + compliant outer-sandbox/protocol proof | next |
