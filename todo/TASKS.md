...
| SUP-FUNCTIONS-001 | local | all owned tables | [functions](03-supabase/05-functions-constraints-indexes.md) — workflow migration/tests | first assessment learner-facade slice verified; remaining families, atomicity, and true concurrency evidence | in progress |
